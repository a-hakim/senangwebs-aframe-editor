  ...
  var e,
    ...
    n = {
      454: () => {
        (THREE.EditorControls = function (e, t) {
          ...
          var n = e,
            ...
            i = new THREE.Vector3(),
            a = new THREE.Box3(),
            s = { NONE: -1, ROTATE: 0, ZOOM: 1, PAN: 2 },
            l = s.NONE,
            c = this.center,
            u = new THREE.Matrix3(),
            p = new THREE.Vector2(),
          ...
          (this.focus = function (e) {
            if (!this.isOrthographic) {
              var t;
              a.setFromObject(e),
                !1 !== a.isEmpty() || isNaN(a.min.x)
                  ? (c.setFromMatrixPosition(e.matrixWorld), (t = 0.1))
                  : (a.getCenter(c), (t = a.getBoundingSphere(m).radius)),
                n.position.copy(
                  e.localToWorld(new THREE.Vector3(0, c.y + 0.5 * t, 2.5 * t))
                );
              var o = e.getWorldPosition(new THREE.Vector3());
              (o.y = c.y), n.lookAt(o), r.dispatchEvent(h);
            }
          }),
            (this.pan = function (e) {
              var t;
          ...
          function b(e) {
            !1 !== r.enabled &&
              ...
              t.addEventListener('mouseup', g, !1),
              t.addEventListener('mouseout', g, !1),
              t.addEventListener('dblclick', g, !1));
          }
          function v(e) {
            if (!1 !== r.enabled) {
              ...
              var t = p.x - f.x,
                n = p.y - f.y;
              l === s.ROTATE
                ? r.rotate(i.set(-t * r.rotationSpeed, -n * r.rotationSpeed, 0))
                : l === s.ZOOM
                  ? r.zoom(i.set(0, 0, n))
                  : l === s.PAN && r.pan(i.set(-t, n, 0)),
                f.set(e.clientX, e.clientY);
            }
          }
          function g(e) {
            t.removeEventListener('mousemove', v, !1),
              t.removeEventListener('mouseup', g, !1),
              t.removeEventListener('mouseout', g, !1),
              t.removeEventListener('dblclick', g, !1),
              (l = s.NONE);
          }
          function A(e) {
            e.preventDefault(), r.zoom(i.set(0, 0, e.deltaY > 0 ? 1 : -1));
          }
          function C(e) {
            e.preventDefault();
          }
          (this.setAspectRatio = function (e) {
            ...
            (this.zoom = function (e) {
              ...
              if ((e.multiplyScalar(t * r.zoomSpeed), !(e.length() > t))) {
                if (
                  (e.applyMatrix3(u.getNormalMatrix(n.matrix)),
                  this.isOrthographic)
                ) {
            ...
            (this.rotate = function (e) {
              this.rotationEnabled &&
                (o.copy(n.position).sub(c),
                d.setFromVector3(o),
                (d.theta += e.x),
                (d.phi += e.y),
                d.makeSafe(),
                o.setFromSpherical(d),
                n.position.copy(c).add(o),
                n.lookAt(c),
                r.dispatchEvent(h));
            }),
          ...
          var w = [
            ...
            x = [new THREE.Vector3(), new THREE.Vector3(), new THREE.Vector3()],
            E = null;
          function O(e) {
            if (!1 !== r.enabled) {
              switch (e.touches.length) {
                ...
                case 2:
                  w[0].set(e.touches[0].pageX, e.touches[0].pageY, 0),
                    ...
                    (E = w[0].distanceTo(w[1]));
              }
              x[0].copy(w[0]), x[1].copy(w[1]);
            }
          }
          function S(e) {
            if (!1 !== r.enabled) {
              switch (
                ...
                case 1:
                  w[0].set(e.touches[0].pageX, e.touches[0].pageY, 0),
                    w[1].set(e.touches[0].pageX, e.touches[0].pageY, 0),
                    r.rotate(
                      w[0].sub(a(w[0], x)).multiplyScalar(-r.rotationSpeed)
                    );
                  break;
                case 2:
                  w[0].set(e.touches[0].pageX, e.touches[0].pageY, 0),
                  ...
                  r.zoom(i.set(0, 0, E - t)), (E = t);
                  var n = w[0].clone().sub(a(w[0], x)),
                    o = w[1].clone().sub(a(w[1], x));
                  (n.x = -n.x),
                    (o.x = -o.x),
                    r.pan(n.add(o).multiplyScalar(0.5));
              }
              x[0].copy(w[0]), x[1].copy(w[1]);
            }
            function a(e, t) {
            ...
            (THREE.TransformControls = (function (e) {
              function t(e, n) {
                    ...
                    if (0 === t.button || void 0 === t.button) {
                      ...
                      if (n) {
                        e.preventDefault(),
                          ...
                          l.dispatchEvent(h),
                          l.update(),
                          S.copy($).sub(W).normalize(),
                          p[c].setActivePlane(l.axis, S);
                        var r = J(t, [p[c].activePlane]);
                        r &&
                          (F.copy(l.object.position),
                          D.copy(l.object.scale),
                          V.extractRotation(l.object.matrix),
                          Q.extractRotation(l.object.matrixWorld),
                          H.extractRotation(l.object.parent.matrixWorld),
                      ...
                      if (
                        ...
                        A.sub(C),
                          ...
                          ('world' !== l.space &&
                            ...
                            -1 === l.axis.search('Y') && (A.y = 0),
                            -1 === l.axis.search('Z') && (A.z = 0),
                            A.applyMatrix4(k.copy(H).invert()),
                            l.object.position.copy(F),
                            l.object.position.add(A)),
                        ...
                        A.sub(C),
                          ...
                          'local' === l.space &&
                            ('XYZ' === l.axis
                              ? ((E = 1 + A.y / Math.max(D.x, D.y, D.z)),
                                (l.object.scale.x = D.x * E),
                                (l.object.scale.y = D.y * E),
                                (l.object.scale.z = D.z * E))
                              : (A.applyMatrix4(k.copy(Q).invert()),
                                'X' === l.axis &&
                                  (l.object.scale.x = D.x * (1 + A.x / D.x)),
                                'Y' === l.axis &&
                                  (l.object.scale.y = D.y * (1 + A.y / D.y)),
                                'Z' === l.axis &&
                                  (l.object.scale.z = D.z * (1 + A.z / D.z))));
                      else if ('rotate' === c)
                        if (
                          (A.sub(W),
                          A.multiply(U),
                          ...
                          A.applyMatrix4(k.copy(O).invert()),
                            T.applyMatrix4(k.copy(O).invert()),
                            w.set(
                              Math.atan2(A.z, A.y),
                              Math.atan2(A.x, A.z),
                              Math.atan2(A.y, A.x)
                            ...
                            j.setFromRotationMatrix(k.copy(H).invert()),
                            z.setFromAxisAngle(S, w.z - x.z),
                            _.setFromRotationMatrix(Q),
                            j.multiplyQuaternions(j, z),
                            j.multiplyQuaternions(j, _),
                            l.object.quaternion.copy(j);
                        else if ('XYZE' === l.axis) {
                          var n = A.clone().cross(T).normalize();
                          z.setFromEuler(P.set(n.x, n.y, n.z)),
                            j.setFromRotationMatrix(k.copy(H).invert()),
                            B.setFromAxisAngle(z, -A.clone().angleTo(T)),
                            _.setFromRotationMatrix(Q),
                            j.multiplyQuaternions(j, B),
                            j.multiplyQuaternions(j, _),
                            l.object.quaternion.copy(j);
                        } else
                          'local' === l.space
                            ? (A.applyMatrix4(k.copy(Q).invert()),
                              T.applyMatrix4(k.copy(Q).invert()),
                              w.set(
                                Math.atan2(A.z, A.y),
                                Math.atan2(A.x, A.z),
                                Math.atan2(A.y, A.x)
                              ...
                              null !== l.rotationSnap
                                ...
                                : (B.setFromAxisAngle(R, w.x - x.x),
                                  N.setFromAxisAngle(M, w.y - x.y),
                                  L.setFromAxisAngle(I, w.z - x.z)),
                              'X' === l.axis && _.multiplyQuaternions(_, B),
                              'Y' === l.axis && _.multiplyQuaternions(_, N),
                              'Z' === l.axis && _.multiplyQuaternions(_, L),
                              l.object.quaternion.copy(_))
                            : 'world' === l.space &&
                              (w.set(
                                Math.atan2(A.z, A.y),
                                Math.atan2(A.x, A.z),
                              ...
                              null !== l.rotationSnap
                                ...
                                : (B.setFromAxisAngle(R, w.x - x.x),
                                  ...
                                  L.setFromAxisAngle(I, w.z - x.z)),
                              _.setFromRotationMatrix(Q),
                              'X' === l.axis && j.multiplyQuaternions(j, B),
                              'Y' === l.axis && j.multiplyQuaternions(j, N),
                              'Z' === l.axis && j.multiplyQuaternions(j, L),
                              j.multiplyQuaternions(j, _),
                              l.object.quaternion.copy(j));
                      'translate' === c
                ...
                function J(e, t) {
                  ...
                  g.set(2 * i - 1, -2 * a + 1), v.setFromCamera(g, o);
                  var s = v.intersectObjects(t, !0);
                  return !!s[0] && s[0];
                }
                return (
                  ...
                  (r.activate = function () {
                    n.addEventListener('mousedown', q, !1),
                      n.addEventListener('touchstart', q, !1),
                  ...
                  r.activate(),
                  (r.dispose = function () {
                    n.removeEventListener('mousedown', q),
                      n.removeEventListener('touchstart', q),
                      n.removeEventListener('mousemove', G),
                      n.removeEventListener('touchmove', G),
                      n.removeEventListener('mousemove', Z),
                  ...
                  (r.update = function (e) {
                    void 0 !== l.object &&
                      ...
                      W.setFromMatrixPosition(l.object.matrixWorld),
                      Y.setFromRotationMatrix(
                        k.extractRotation(l.object.matrixWorld)
                      ),
                      o.updateMatrixWorld(),
                      $.setFromMatrixPosition(o.matrixWorld),
                      X.setFromRotationMatrix(k.extractRotation(o.matrixWorld)),
                      (E = (W.distanceTo($) / 6) * l.size),
      ...
      600: (e, t, n) => {
        ...
        a.push([
          e.id,
          'svg:not(:root).svg-inline--fa,svg:not(:host).svg-inline--fa{overflow:visible;box-sizing:content-box}.svg-inline--fa{display:inline-block;height:1em;overflow:visible;vertical-align:-.125em}body.aframe-inspector-opened,.toggle-edit{font-family:BlinkMacSystemFont,-apple-system,"Segoe UI",Helvetica,Arial,sans-serif}.wf-roboto-n4-active body.aframe-inspector-opened,.wf-roboto-n4-active .toggle-edit{font-family:BlinkMacSystemFont,-apple-system,"Segoe UI",Helvetica,Arial,sans-serif}body.aframe-inspector-opened{background:#09090b;color:#fff;font-size:12px;margin:0;overflow:hidden}#aframeInspector svg:not(:root).svg-inline--fa,#aframeInspector svg:not(:host).svg-inline--fa{overflow:visible;box-sizing:content-box}#aframeInspector .svg-inline--fa{display:inline-block;height:1em;overflow:visible;vertical-align:-.125em}#aframeInspector #toolbar{background-color:#09090b}#aframeInspector #toolbar .toolbarActions{padding:0;height:48px;display:grid;grid-template-columns:repeat(2,minmax(0,1fr))}#aframeInspector #toolbar .toolbarActions a.button{display:flex;justify-content:center;align-items:center;flex-direction:column;margin:0}#aframeInspector #toolbar .toolbarActions a.button svg{color:inherit}#aframeInspector #toolbar .toolbarActions a.button span{font-size:12px}#aframeInspector #toolbar .toolbarActions a.button:hover{color:#0f9}#aframeInspector #toolbar .toolbarActions a.disabled{color:#666;cursor:default}#aframeInspector #scenegraph{background:#18181b;border-top:1px solid #111;display:flex;flex-direction:column;overflow:auto;width:20rem;height:calc(100vh - 40px);top:40px;position:absolute}#aframeInspector #scenegraph .entity{background:#18181b;cursor:pointer;display:flex;justify-content:space-between;padding:10px;white-space:nowrap}#aframeInspector #scenegraph .entity:hover{background:#1d2f39}#aframeInspector #scenegraph .entity.active{background-color:#09090b;color:#fff}#aframeInspector #scenegraph .entity.active .component:hover{color:#1888c1}#aframeInspector #scenegraph .entity.active .entityActions{display:flex}#aframeInspector #scenegraph .entity.novisible.active span,#aframeInspector #scenegraph .entity.novisible.active svg,#aframeInspector #scenegraph .entity.novisible.active .collapsespace,#aframeInspector #scenegraph .entity.novisible.active .id{color:#999}#aframeInspector #scenegraph .entity.novisible:not(.active) span,#aframeInspector #scenegraph .entity.novisible:not(.active) svg,#aframeInspector #scenegraph .entity.novisible:not(.active) .collapsespace,#aframeInspector #scenegraph .entity.novisible:not(.active) .id{color:#626262}#aframeInspector #scenegraph .component:hover{color:#1faaf2}#aframeInspector #scenegraph .entityIcons{margin-left:2px}#aframeInspector #scenegraph .entityActions{display:none;margin:0 4px}#aframeInspector #scenegraph .entityActions .button{color:#fff;font-size:12px;margin-left:6px}#aframeInspector #scenegraph svg{color:#ccc}#aframeInspector #scenegraph .entityActions svg:hover{color:#0f9}#aframeInspector #scenegraph .active svg{color:#fafafa}#aframeInspector #scenegraph .id{color:#ccc}#aframeInspector #scenegraph .option.active .id{color:#fff}#aframeInspector #scenegraph .collapsespace{color:#eee;display:inline-block;text-align:center;width:14px;margin-left:8px}#aframeInspector #scenegraph .fa-eye{color:#bbb}#aframeInspector #scenegraph .icons a.button{color:#fff}#aframeInspector #scenegraph .search{padding:0;font-size:16px;position:relative;overflow:hidden}#aframeInspector #scenegraph .search input{color:#a3a3a3;background:#18181b;border-radius:0;border-bottom:1px solid #09090b;height:40px;text-indent:10px;width:20rem}#aframeInspector #scenegraph .search svg{position:absolute;right:12px;top:12px}#aframeInspector #scenegraph .outliner{background:#18181b;color:#a3a3a3;cursor:default;flex:1 1 auto;font-size:14px;line-height:normal;outline:none;overflow-y:auto;padding:0;width:20rem}#aframeInspector .scenegraph-bottom{background-color:#323232;border-top:1px solid #111;bottom:10;height:40px;left:0;z-index:100}#aframeInspector .scenegraph-bottom a{float:right;margin:10px}#aframeInspector svg:not(:root).svg-inline--fa,#aframeInspector svg:not(:host).svg-inline--fa{overflow:visible;box-sizing:content-box}#aframeInspector .svg-inline--fa{display:inline-block;height:1em;overflow:visible;vertical-align:-.125em}#aframeInspector .components{background-color:#18181b;color:#a3a3a3;height:100%;overflow:auto;width:20rem}#aframeInspector div.vec2,#aframeInspector div.vec3,#aframeInspector div.vec4{display:flex;gap:4px}#aframeInspector .vec2 input.number,#aframeInspector .vec3 input.number{width:50px}#aframeInspector .vec4 input.number{width:34px}#aframeInspector .collapsible-header{align-items:center;display:flex;justify-content:space-between}#aframeInspector .collapsible-header .entityPrint{color:#fff}#aframeInspector .collapsible-content{padding:5px 0;display:flex;flex-direction:column;gap:8px}#aframeInspector .componentTitle span{max-width:200px;overflow:hidden;text-overflow:ellipsis;text-transform:uppercase;white-space:nowrap;color:#fff;font-weight:600;vertical-align:bottom !important}#aframeInspector .collapsible .static{background:#18181b;border-bottom:2px solid #18181b;box-sizing:content-box;cursor:pointer;padding:12px 10px;vertical-align:bottom;font-size:12px}#aframeInspector .collapsible .static:hover{background:#2e2e33}#aframeInspector .collapsible .menu{text-align:right}#aframeInspector .collapsible .menuafter{color:#bbb;content:\'\\2807\';font-size:12px;padding:5px;text-align:right}#aframeInspector .collapsible .static{margin:0}#aframeInspector .collapsible .static .collapse-button{border:6px solid transparent;float:left;height:0;margin-right:10px;margin-left:2px;width:0}#aframeInspector .collapsible.collapsed .static .collapse-button{border-left-color:#a3a3a3;margin-top:4px}#aframeInspector .collapsible:not(.collapsed) .static .collapse-button{border-top-color:#a3a3a3;margin-top:7px}#aframeInspector .propertyRow{display:flex;flex-direction:column;font-size:12px;min-height:30px;padding:2px 15px}#aframeInspector .propertyRow .text{cursor:default;display:inline-block;overflow:hidden;padding-bottom:4px;text-overflow:ellipsis;vertical-align:middle;width:180px;text-transform:capitalize}#aframeInspector .propertyRow .map_value{margin:0 0 0 5px;width:68px}#aframeInspector .propertyRow .Select-control{font-size:11px;height:24px}#aframeInspector .propertyRow .Select-placeholder,#aframeInspector .propertyRow .Select--single > .Select-control .Select-value{line-height:19px}#aframeInspector .propertyRow .Select-input{height:22px}#aframeInspector .propertyRow input[type=text],#aframeInspector .propertyRow input[type=number],#aframeInspector .propertyRow input.string,#aframeInspector .propertyRow input.number{background:#09090b;border-radius:8px;color:#fff;min-height:32px;padding-bottom:1px;padding-left:8px;padding-right:8px;padding-top:1px}#aframeInspector .propertyRow input[type=text]:last-child,#aframeInspector .propertyRow input[type=number]:last-child,#aframeInspector .propertyRow input.string:last-child,#aframeInspector .propertyRow input.number:last-child{padding-right:0}#aframeInspector .propertyRow input.string{padding-left:8px;box-sizing:border-box;width:100%}#aframeInspector .propertyRow input[type=text]:focus,#aframeInspector .propertyRow input.string:focus{box-shadow:none}#aframeInspector .propertyRow .color_value{margin:0 0 0 5px;width:68px;letter-spacing:1px}#aframeInspector .propertyRowDefined .text{color:#0f9;font-weight:500}#aframeInspector .components *{vertical-align:middle}#aframeInspector span.subcomponent{color:#999;float:none !important;margin-left:10px;vertical-align:top !important}#aframeInspector a.help-link{opacity:.4}#aframeInspector a.help-linkhover{opacity:1}#aframeInspector #addComponentContainer{align-items:center;display:flex;flex-direction:column;justify-content:center;padding:20px 10px;background:#09090b}#aframeInspector #addComponentContainer #addComponent{text-align:left;width:200px}#aframeInspector #addComponentContainer #addComponent .select__control{background:#161616;height:35px;color:#0f9}#aframeInspector #addComponentContainer #addComponent .option{display:flex;justify-content:space-between}#aframeInspector #addComponentContainer #addComponent .option span{color:#0f9}#aframeInspector #addComponentContainer #addComponentHeader{font-size:15px;margin:5px 0 10px 0}#aframeInspector #addComponentContainer input[type=text]:focus{box-shadow:none}#aframeInspector .Select-menu-outer .is-focused span{color:#fff}#aframeInspector .component-title{align-items:center;display:flex}#aframeInspector #componentEntityHeader .collapsible-header{bottom:4px;position:relative}#aframeInspector #componentEntityHeader .collapse-button{display:none}#aframeInspector #componentEntityHeader .static{height:14px}#aframeInspector #componentEntityHeader .entityPrint{font-size:15px;padding-left:5px}#aframeInspector #componentEntityHeader .entityName{max-width:160px;top:0}#aframeInspector #componentEntityHeader .entityIcons{color:#fafafa}#aframeInspector #mixinSelect{width:100%}#aframeInspector .propertyRow .texture{display:flex;gap:4px}#aframeInspector .propertyRow .texture input{margin-left:0}#aframeInspector #componentEntityHeader .gltfIcon img{top:0}#aframeInspector svg{color:#a3a3a3}#aframeInspector svg:hover{color:#0f9}#aframeInspector svg:not(:root).svg-inline--fa,#aframeInspector svg:not(:host).svg-inline--fa{overflow:visible;box-sizing:content-box}#aframeInspector .svg-inline--fa{display:inline-block;height:1em;overflow:visible;vertical-align:-.125em}#aframeInspector .entityPrint{font-family:system-ui,BlinkMacSystemFont,-apple-system,"Segoe UI",Helvetica,Arial,sans-serif;line-height:1.15em}#aframeInspector .entityName{display:inline-block;overflow:hidden;position:relative;text-overflow:ellipsis;top:3px;white-space:nowrap}#aframeInspector [data-entity-name-type="id"]{color:#0f9}#aframeInspector [data-entity-name-type="class"]{color:#22d3ee}#aframeInspector [data-entity-name-type="mixin"]{color:#d66853}#aframeInspector .help-lists{display:flex;justify-content:space-around}#aframeInspector .help-list{list-style:none;margin:0;padding:0 0 10px;width:350px}#aframeInspector .help-list li{margin-right:40px}#aframeInspector .help-key-unit{line-height:1.8;margin-right:2em;padding:5px 0}#aframeInspector .help-key{bottom:2px;margin-right:4px;min-width:60px;position:relative}#aframeInspector .help-key span{background-color:#2e2e2e;background-repeat:repeat-x;border:1px solid #666;border-radius:3px;box-shadow:0 0 5px #000;color:#999;display:inline-block;font-size:12px;padding:0 8px;text-align:center}#aframeInspector .help-key-def{color:#bbb;display:inline-block;margin-left:1em}#aframeInspector svg:not(:root).svg-inline--fa,#aframeInspector svg:not(:host).svg-inline--fa{overflow:visible;box-sizing:content-box}#aframeInspector .svg-inline--fa{display:inline-block;height:1em;overflow:visible;vertical-align:-.125em}#aframeInspector .select__control{border:0;border-radius:8px;cursor:pointer;min-height:32px;font-family:system-ui,BlinkMacSystemFont,-apple-system,"Segoe UI",Helvetica,Arial,sans-serif;font-size:14px}#aframeInspector .select__indicator{height:26px}#aframeInspector .select__indicator-separator{display:none}#aframeInspector .select__input{min-height:auto !important}#aframeInspector .select__control,#aframeInspector .select__menu{background:#09090b}#aframeInspector .select__option{padding:5px 10px}#aframeInspector .select__placeholder,#aframeInspector .select__menu{color:#a3a3a3}#aframeInspector .select__single-value{color:#fff}#aframeInspector .select__control--is-focused{box-shadow:none !important}#aframeInspector .select__option{cursor:pointer}#aframeInspector .select__clear-indicator{display:none}#aframeInspector .select__label{font-size:14px}#aframeInspector .select__option--is-focused{background:#18181b}#aframeInspector .select__value-container{height:32px;position:static}#aframeInspector .select__value-container.select__value-container--is-multi{height:auto;padding:6px}#aframeInspector .select__dropdown-indicator{padding:3px 8px}#aframeInspector .select__multi-value{background:#18181b;color:#0f9}#aframeInspector .select__multi-value__label{color:#0f9}#aframeInspector .select__value-container--is-multi > :last-child{display:none}#aframeInspector .select__multi-value__remove:hover{color:#fff;background:#18181b}#aframeInspector .modal{animation:animateopacity .2s ease-out;background-color:#000;background-color:rgba(0,0,0,0.6);display:flex;height:100%;left:0;overflow:auto;position:fixed;top:0;width:100%;z-index:9999999999}#aframeInspector .modal h3{font-size:16px;font-weight:500;margin:.6em 0}#aframeInspector #textureModal .modal-content{height:calc(100% - 96px);width:calc(100% - 96px);border-radius:8px}#aframeInspector .modal-content{animation:animatetop .2s ease-out;animation-duration:.2s;animation-name:animatetop;background-color:#232323;box-shadow:0 4px 8px 0 rgba(0,0,0,0.5),0 6px 20px 0 rgba(0,0,0,0.5);margin:auto;overflow:hidden;padding:0}#aframeInspector .close{color:rgba(255,255,255,0.502);float:right;font-size:24px;font-weight:bold}#aframeInspector .closehover,#aframeInspector .closefocus{color:#08f;cursor:pointer;text-decoration:none}#aframeInspector .modal-header{color:#fff;padding:2px 16px}#aframeInspector .modal-body{overflow:auto;padding:16px;height:inherit}#aframeInspector .modal-footer{color:#fff;padding:2px 16px}#aframeInspector .gallery{background:#232323;display:flex;flex-wrap:wrap;margin:15px auto 0;overflow:auto;padding:15px 3px 3px}#aframeInspector .newimage .gallery{padding:8px}#aframeInspector .gallery li{border-radius:8px;box-shadow:0 0 6px rgba(0,0,0,0.6);cursor:pointer;margin:8px;overflow:hidden;width:155px}#aframeInspector .gallery li.selected,#aframeInspector .gallery li:hover{box-shadow:0 0 0 2px #0f9}#aframeInspector .gallery li .detail{background-color:#323232;margin:0;min-height:60px;padding:4px 8px 8px 8px}#aframeInspector .preview{padding:10px;width:150px}#aframeInspector .preview input{display:block;margin:8px 0;width:144px}#aframeInspector .preview button{width:155px}#aframeInspector .preview .detail .title{color:#fff;display:inline-block;max-width:155px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}#aframeInspector .gallery li.selected .detail,#aframeInspector .gallery li:hover .detail{background-color:#444}#aframeInspector .gallery li .detail span{color:#777;display:block;margin-top:4px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;width:140px}#aframeInspector .gallery li.selected .detail span,#aframeInspector .gallery li:hover .detail span{color:#888}#aframeInspector .gallery li .detail span.title{color:#fff !important}#aframeInspector .modal button{-webkit-appearance:none;-moz-appearance:none;appearance:none;border-radius:0;box-shadow:none;cursor:pointer;display:inline-block;font-size:12px;line-height:1.8;margin:0 10px 0 0;padding:5px 10px}#aframeInspector .modal buttonfocus{outline:none}#aframeInspector .modal button{background-color:#09090b;border:none;color:#fff;border-radius:8px;font-weight:500;padding:8px 16px;text-transform:capitalize}#aframeInspector .modal buttonhover,#aframeInspector .modal button.hover{background-color:#346392;text-shadow:-1px 1px #27496d}#aframeInspector .modal buttonactive,#aframeInspector .modal button.active{background-color:#27496d;text-shadow:-1px 1px #193047}#aframeInspector .modal buttondisabled{background-color:#888;cursor:none}#aframeInspector .newimage{background-color:#323232;color:#a3a3a3;display:flex;font-size:14px;justify-content:space-between;margin-top:16px;overflow:auto;padding:8px;border-radius:8px}#aframeInspector .newimage input{color:#0f9;padding:3px 5px}#aframeInspector .texture canvas + input{margin-left:5px}#aframeInspector .texture svg{padding-right:5px}#aframeInspector .uploader-normal-button .hidden{display:none}#aframeInspector .assets.search{position:relative;margin-top:10px;width:200px}#aframeInspector .assets.search svg{position:absolute;right:0;top:5px}#aframeInspector .new_asset_options{margin:10px}#aframeInspector .new_asset_options > ul{margin-left:10px;padding:5px}#aframeInspector .new_asset_options > ul > li{padding:10px 0}#aframeInspector .new_asset_options .imageUrl{margin-left:5px;width:350px}#aframeInspector .texture canvas{border:1px solid rgba(255,255,255,0.15);border-radius:8px;cursor:pointer}#aframeInspector svg:not(:root).svg-inline--fa,#aframeInspector svg:not(:host).svg-inline--fa{overflow:visible;box-sizing:content-box}#aframeInspector .svg-inline--fa{display:inline-block;height:1em;overflow:visible;vertical-align:-.125em}#aframeInspector #viewportBar{align-items:center;background-color:#18181b;color:#a3a3a3;position:absolute;right:0;top:0;flex-grow:2;display:flex;height:40px;font-size:15px;justify-content:space-between;margin:0 auto;width:100vw}#aframeInspector #viewportBar .scenegraph-menubar{display:flex;height:40px;width:20rem;justify-content:space-between}#aframeInspector #viewportBar .viewportHud-menubar{display:flex;height:40px;width:20rem;align-items:center;justify-content:flex-end}#aframeInspector #viewportHud{padding:4px 8px;margin:0 .5rem}#aframeInspector #viewportHud p{margin:0;font-size:14px}#aframeInspector #pageToolbar{display:flex;align-items:center;height:48px}#aframeInspector #pageToolbar .button{width:48px;height:48px;border:0;background:none;font-size:16px;cursor:pointer}#aframeInspector #pageToolbar .button:hover{background:#141417}#aframeInspector #pageToolbar .button:hover svg{color:#0f9}#aframeInspector .toolbarButtons{display:flex;align-items:center;height:40px}#aframeInspector .toolbarButtons *{margin-left:0 !important;vertical-align:middle;height:48px;display:flex;align-items:center}#aframeInspector .toolbarButtons a.button svg{padding:12px}#aframeInspector .toolbarButtons a.button:not(.active) svg:hover{background-color:#141417}#aframeInspector .toolbarButtons .active svg{background-color:#141417 !important;color:#0f9}#aframeInspector .toolbarButtons .active:hover svg{color:#fff !important}#aframeInspector .local-transform{padding-left:10px;padding-right:20px}#aframeInspector .local-transform label{color:#aaa;padding-left:8px;font-size:14px}#aframeInspector .local-transform a.button{padding-top:0}#aframeInspector #cameraSelect{cursor:pointer;width:120px}#aframeInspector #cameraSelect .select__dropdown-indicator{padding-left:3px;padding-right:3px}#aframeInspector #cameraToolbar{margin-right:8px;align-items:center;display:flex;background-color:#09090b;border-radius:8px;height:28px}#aframeInspector #cameraToolbar a{margin-right:10px}#aframeInspector #cameraToolbar .select__control{background:none}#aframeInspector #cameraToolbar .select__single-value{color:#a3a3a3;font-size:14px}#aframeInspector #cameraToolbar .select__single-value:hover{color:#0f9}#aframeInspector #viewportHud{display:none}@media (min-width:1024px){#aframeInspector #viewportHud{display:block}}#aframeInspector svg:not(:root).svg-inline--fa,#aframeInspector svg:not(:host).svg-inline--fa{overflow:visible;box-sizing:content-box}#aframeInspector .svg-inline--fa{display:inline-block;height:1em;overflow:visible;vertical-align:-.125em}#aframeInspector .Select-control{background-color:#222 !important;border:none;border-radius:0;color:#0f9;font-family:$monosapce}#aframeInspector .Select-menu-outer{border:none}#aframeInspector .Select-menu-outer .is-focused{background-color:#0f9 !important;color:#a3a3a3}#aframeInspector .Select-option{background-color:#222 !important}#aframeInspector .select-widget{display:inline-block;width:100%;border-radius:8px}#aframeInspector .Select-placeholder,#aframeInspector .Select--single > .Select-control .Select-value{color:#0f9 !important}#aframeInspector .Select-value-label{color:#0f9 !important}#aframeInspector .dropbtn{border:none;color:#a3a3a3;cursor:pointer}#aframeInspector .dropdown{display:inline-block;position:relative}#aframeInspector .dropdown-content{background-color:#f9f9f9;box-shadow:0 8px 16px 0 rgba(0,0,0,0.2);display:none;left:8px;min-width:38px;position:absolute;z-index:999}#aframeInspector .dropdown-content a{background-color:#232323;color:#7d7d7d;display:block;padding:10px 14px;text-decoration:none}#aframeInspector .dropdown-content a:hover{background-color:#4ecbff;color:#a3a3a3}#aframeInspector .dropdownhover .dropdown-content{display:block}#aframeInspector .dropdownhover .dropbtn{color:#0f9}#aframeInspector .color-widget{display:flex;justify-content:space-between;align-items:center}#aframeInspector .Select,#aframeInspector code,#aframeInspector pre,#aframeInspector input,#aframeInspector textarea,#aframeInspector select{font-family:system-ui,BlinkMacSystemFont,-apple-system,"Segoe UI",Helvetica,Arial,sans-serif;font-size:14px}#aframeInspector .wf-robotomono-n4-active .Select,#aframeInspector .wf-robotomono-n4-active code,#aframeInspector .wf-robotomono-n4-active pre,#aframeInspector .wf-robotomono-n4-active input,#aframeInspector .wf-robotomono-n4-active textarea,#aframeInspector .wf-robotomono-n4-active select{font-family:Roboto Mono,Consolas,Andale Mono,Monaco,Courier New,monospace}#aframeInspector hr{border:0;border-top:1px solid #ccc}#aframeInspector a{cursor:pointer}#aframeInspector button{position:relative}#aframeInspector code{font-family:Consolas,Andale Mono,Monaco,Lucida Console,Liberation Mono,DejaVu Sans Mono,Bitstream Vera Sans Mono,Courier New,monospace}#aframeInspector textarea{-moz-tab-size:4;-o-tab-size:4;tab-size:4;white-space:pre;word-wrap:normal}#aframeInspector textarea.success{border-color:#8b8 !important}#aframeInspector textarea.fail{background-color:rgba(255,0,0,0.05);border-color:#f00 !important}#aframeInspector textarea,#aframeInspector input{outline:none}#aframeInspector .gltfIcon img{box-sizing:content-box;display:inline;height:20px;left:5px;padding:0 5px;position:relative;top:4px;vertical-align:baseline;width:20px}#aframeInspector #scenegraph,#aframeInspector #rightPanel{z-index:20}#aframeInspector #sidebar,#aframeInspector #scenegraph,#aframeInspector .panel{cursor:default;-webkit-user-select:none;-moz-user-select:none;user-select:none}#aframeInspector #sceneActions{display:flex;flex-direction:row;position:absolute;bottom:0;z-index:40;width:calc(20rem - 48px);height:48px;background:#18181b;padding-left:48px}#aframeInspector #sceneActions .sceneActionsTitle{letter-spacing:.1em;line-height:1rem;font-size:.75rem;padding:.25rem;text-align:center;background:#303032;color:#989899;font-weight:500}#aframeInspector #sceneActions .sceneActionsButton{display:flex}#aframeInspector .toggle-edit{background-color:#18181b;box-sizing:content-box;color:#fff;font-size:16px;left:0;line-height:normal;margin:0;position:fixed;text-align:center;text-decoration:none;bottom:0;width:0;height:0;opacity:0;display:flex;align-items:center;justify-content:center;z-index:40;font-weight:500;border-top:1px solid #09090b}#aframeInspector .toggle-edit:hover{background-color:#09090b;color:#fff}#aframeInspector .toggle-edit:hover svg{color:#0f9}#aframeInspector .toggle-save,#aframeInspector .toggle-live{background-color:#18181b;color:#fff;height:40px;display:flex;align-items:center;justify-content:center;border:0;font-size:16px;font-weight:500;cursor:pointer}#aframeInspector .toggle-save:hover,#aframeInspector .toggle-live:hover{background-color:#09090b}#aframeInspector #saveSceneBtn{width:10rem}#aframeInspector #liveSceneBtn{width:10rem}#aframeInspector input{border:1px solid #555;color:#fff}#aframeInspector input,#aframeInspector .texture canvas{transition:.1s background-color ease-in-out,.1s border-color ease-in-out,.1s color ease-in-out}#aframeInspector input[type=text],#aframeInspector input[type=number],#aframeInspector input.string,#aframeInspector input.number{min-height:14px;outline:none}#aframeInspector input[type="checkbox"]{-webkit-appearance:auto;-moz-appearance:auto;appearance:auto;cursor:pointer;margin:0;height:18px;width:18px}#aframeInspector input[type="checkbox"]:focus{box-shadow:none}#aframeInspector input.number{border:0;color:#fff !important;cursor:col-resize;font-size:14px;padding:2px}#aframeInspector input.stringfocus,#aframeInspector input.numberfocus{border:1px solid #20b1fb;color:#fff;cursor:auto}#aframeInspector input.error{border:1px solid #a00}#aframeInspector #sidebar{background:#18181b;width:20rem}#aframeInspector #sidebar *{vertical-align:middle}#aframeInspector input,#aframeInspector textarea,#aframeInspector select{background:#222;border:1px solid transparent;color:#888}#aframeInspector select{background:#2e2e33}#aframeInspector input[type=color]{background-color:#333;border:1px solid #111;height:28px;cursor:pointer}#aframeInspector input[type=color]{cursor:pointer;height:25px;padding:0;width:50px}#aframeInspector input[type=color]-webkit-color-swatch{border:0}#aframeInspector input[type=color]-webkit-color-swatch-wrapper{padding:0}#aframeInspector input[type=color]-moz-color-swatch{border:0}#aframeInspector input[type=color]-moz-focus-inner{border:0;padding:0}#aframeInspector .hidden{visibility:hidden}#aframeInspector a.button{color:#a3a3a3;font-size:16px;margin-left:8px;display:flex;align-items:center;justify-content:center;text-decoration:none}#aframeInspector a.buttonhover{color:#1faaf2}#aframeInspector .hide{display:none}#aframeInspector .a-canvas.state-dragging{cursor:grabbing}#aframeInspector #rightPanel{align-items:stretch;display:flex;justify-content:flex-end;height:calc(100vh - 40px);padding-top:0;padding-right:0;position:absolute;right:0;top:40px}#aframeInspector #inspectorContainer{display:flex;justify-content:space-between;left:0;height:100%;pointer-events:none;position:fixed;top:0;width:100%;z-index:20}#aframeInspector #scenegraph,#aframeInspector #viewportBar,#aframeInspector #rightPanel{pointer-events:all}#aframeInspector .aframe-inspector-opened a-scene .a-canvas{background-color:#191919;z-index:9999}#aframeInspector .toggle-sidebar{align-items:center;display:flex;height:100%;position:absolute;z-index:40}#aframeInspector .toggle-sidebar a{background-color:#262626;color:#a3a3a3;padding:5px;z-index:40}#aframeInspector .toggle-sidebar a.hover{background-color:#1faaf2;color:#fff}#aframeInspector .toggle-sidebar.left{top:0;left:0}#aframeInspector .toggle-sidebar.right{top:0;right:0}@keyframes animateopacity{from{opacity:0}to{opacity:1}}',
          '',
          {
            version: 3,
            sources: [
            ...
            names: [],
            mappings:
              'AA8BA,4DACE,gBAAU,CACV,sBAAY,CAGd,gBACE,oBAAS,CACT,UAAQ,CACR,gBAAU,CACV,sBAAgB,CCrClB,0CAEE,kFAA8B,CAEhC,oFAEE,kFAA8B,CAEhC,6BACE,kBAAW,CACX,UAAM,CACN,cAAU,CACV,QAAO,CACP,eAAS,CDeX,8FACE,gBAAU,CACV,sBAAY,CAGd,iCACE,oBAAS,CACT,UAAQ,CACR,gBAAU,CACV,sBAAgB,CErClB,0BACE,wBAAiB,CAEjB,0CACE,SAAQ,CACR,WAAO,CACP,YAAQ,CACR,6CAAsB,CAEtB,mDACE,YAAQ,CACR,sBAAgB,CAChB,kBAAY,CACZ,qBAAe,CACf,QAAO,CAEP,uDACE,aAAM,CAER,wDACE,cAAU,CAEd,yDACE,UAAM,CAER,qDACE,UAAM,CACN,cAAO,CAEb,6BACE,kBAAW,CACX,yBAAW,CACX,YAAQ,CACR,qBAAe,CACf,aAAS,CACT,WAAM,CACN,yBAAO,CACP,QAAI,CACJ,iBAAS,CAET,qCACE,kBAAW,CACX,cAAO,CACP,YAAQ,CACR,6BAAgB,CAChB,YAAQ,CACR,kBAAY,CAEZ,2CACE,kBAAW,CAEb,4CACE,wBAAiB,CACjB,UAAM,CACN,6DACE,aAAM,CACR,2DACE,YAAQ,CAIR,oPAIE,UAAM,CAGR,4QAIE,aAAM,CAEd,8CACE,aAAM,CAER,0CACE,eAAY,CAEd,4CACE,YAAQ,CACR,YAAO,CAEP,oDACE,UAAM,CACN,cAAU,CACV,eAAY,CAEhB,iCACE,UAAM,CAER,sDACE,UAAM,CAER,yCACE,aAAM,CAER,iCACE,UAAM,CAER,gDACE,UAAM,CAER,4CACE,UAAM,CACN,oBAAQ,CACR,iBAAW,CACX,UAAM,CACN,eAAY,CAEd,qCACE,UAAM,CAER,6CACE,UAAM,CAER,qCACE,SAAQ,CACR,cAAU,CACV,iBAAS,CACT,eAAS,CAET,2CACE,aAAM,CACN,kBAAW,CACX,eAAc,CACd,+BAAc,CACd,WAAO,CACP,gBAAY,CACZ,WAAM,CAER,yCACE,iBAAS,CACT,UAAM,CACN,QAAI,CAER,uCACE,kBAAW,CACX,aAAM,CACN,cAAO,CACP,aAAK,CACL,cAAU,CACV,kBAAY,CACZ,YAAQ,CACR,eAAW,CACX,SAAQ,CACR,WAAM,CAEV,oCACE,wBAAiB,CACjB,yBAAW,CACX,SAAO,CACP,WAAO,CACP,MAAK,CACL,WAAQ,CAER,sCACE,WAAM,CACN,WAAO,CFnIX,8FACE,gBAAU,CACV,sBAAY,CAGd,iCACE,oBAAS,CACT,UAAQ,CACR,gBAAU,CACV,sBAAgB,CG/BlB,6BACE,wBAAiB,CACjB,aAAM,CACN,WAAO,CACP,aAAS,CACT,WAAM,CAER,8EAGE,YAAQ,CACR,OAAI,CAEN,wEAEE,UAAM,CAER,oCACE,UAAM,CAER,qCACE,kBAAY,CACZ,YAAQ,CACR,6BAAgB,CAChB,kDACE,UAAM,CAEV,sCACE,aAAQ,CACR,YAAQ,CACR,qBAAe,CACf,OAAI,CAEN,sCACE,eAAU,CACV,eAAS,CACT,sBAAc,CACd,wBAAe,CACf,kBAAY,CACZ,UAAM,CACN,eAAY,CACZ,gCAAe,CAEjB,sCACE,kBAAW,CACX,+BAAc,CACd,sBAAW,CACX,cAAO,CACP,iBAAQ,CACR,qBAAe,CACf,cAAU,CACV,4CACE,kBAAW,CAWf,oCACE,gBAAW,CAEb,yCACE,UAAM,CACN,eAAQ,CACR,cAAU,CACV,WAAQ,CACR,gBAAW,CAEb,sCACE,QAAO,CAET,uDACE,4BAAO,CACP,UAAM,CACN,QAAO,CACP,iBAAa,CACb,eAAY,CACZ,OAAM,CAER,iEACE,yBAAkB,CAClB,cAAW,CAEb,uEACE,wBAAiB,CACjB,cAAW,CAEb,8BACE,YAAQ,CACR,qBAAe,CACf,cAAU,CACV,eAAW,CACX,gBAAQ,CAER,oCACE,cAAO,CACP,oBAAQ,CACR,eAAS,CACT,kBAAe,CACf,sBAAc,CACd,qBAAe,CACf,WAAM,CACN,yBAAe,CAEjB,yCACE,gBAAO,CACP,UAAM,CAER,8CACE,cAAU,CACV,WAAO,CAET,gIAEE,gBAAY,CAEd,4CACE,WAAO,CAET,sLAIE,kBAAW,CACX,iBAAc,CACd,UAAM,CACN,eAAW,CACX,kBAAe,CACf,gBAAa,CACb,iBAAc,CACd,eAAY,CACZ,kOACE,eAAc,CAElB,2CACE,gBAAa,CACb,qBAAW,CACX,UAAM,CAER,sGAEE,eAAW,CAEb,2CACE,gBAAO,CACP,UAAM,CACN,kBAAe,CAEnB,2CACE,UAAM,CACN,eAAY,CAEd,+BACE,qBAAe,CAEjB,mCACE,UAAM,CACN,qBAAM,CACN,gBAAY,CACZ,6BAAe,CAEjB,6BACE,UAAQ,CAEV,kCACE,SAAQ,CAEV,wCACE,kBAAY,CACZ,YAAQ,CACR,qBAAe,CACf,sBAAgB,CAChB,iBAAQ,CACR,kBAAW,CAEX,sDACE,eAAW,CACX,WAAM,CACN,uEACE,kBAAW,CACX,WAAO,CACP,UAAM,CACR,8DACE,YAAQ,CACR,6BAAgB,CAChB,mEACE,UAAM,CAEZ,4DACE,cAAU,CACV,mBAAO,CAET,+DACE,eAAW,CAEf,qDACE,UAAM,CAER,kCACE,kBAAY,CACZ,YAAQ,CAGR,4DACE,UAAO,CACP,iBAAS,CACX,yDACE,YAAQ,CACV,gDACE,WAAO,CACT,qDACE,cAAU,CACV,gBAAa,CACf,oDACE,eAAU,CACV,KAAI,CACN,qDACE,aAAM,CAEV,8BACE,UAAM,CAER,uCACE,YAAQ,CACR,OAAI,CACJ,6CACE,aAAY,CAEhB,sDACE,KAAI,CAEN,qBACE,aAAM,CACN,2BACE,UAAM,CHzNV,8FACE,gBAAU,CACV,sBAAY,CAGd,iCACE,oBAAS,CACT,UAAQ,CACR,gBAAU,CACV,sBAAgB,CIrClB,8BACE,4FAAY,CACZ,kBAAY,CAEd,6BACE,oBAAQ,CACR,eAAS,CACT,iBAAS,CACT,sBAAc,CACd,OAAI,CACJ,kBAAY,CAEd,8CACE,UAAM,CAER,iDACE,aAAM,CAER,iDACE,aAAM,CCrBR,6BACE,YAAQ,CACR,4BAAgB,CAElB,4BACE,eAAW,CACX,QAAO,CACP,gBAAQ,CACR,WAAM,CAER,+BACE,iBAAa,CAEf,gCACE,eAAY,CACZ,gBAAa,CACb,aAAQ,CAEV,2BACE,UAAO,CACP,gBAAa,CACb,cAAU,CACV,iBAAS,CAEX,gCACE,wBAAiB,CACjB,0BAAkB,CAClB,qBAAO,CACP,iBAAc,CACd,uBAAW,CACX,UAAM,CACN,oBAAQ,CACR,cAAU,CACV,aAAQ,CACR,iBAAW,CAEb,+BACE,UAAM,CACN,oBAAQ,CACR,eAAY,CLTd,8FACE,gBAAU,CACV,sBAAY,CAGd,iCACE,oBAAS,CACT,UAAQ,CACR,gBAAU,CACV,sBAAgB,CMrClB,kCACE,QAAO,CACP,iBAAc,CACd,cAAO,CACP,eAAW,CACX,4FAAY,CACZ,cAAU,CAEZ,oCACE,WAAO,CAET,8CACE,YAAQ,CAEV,gCACE,0BAAW,CAEb,iEAEE,kBAAW,CAEb,iCACE,gBAAQ,CAEV,qEAEE,aAAM,CAER,uCACE,UAAM,CAER,8CACE,0BAAW,CAEb,iCACE,cAAO,CAET,0CACE,YAAQ,CAEV,gCACE,cAAU,CAEZ,6CACE,kBAAW,CAEb,0CACE,WAAO,CACP,eAAS,CACT,4EACE,WAAO,CACP,WAAQ,CAEZ,6CACE,eAAQ,CAEV,sCACE,kBAAW,CACX,UAAM,CAER,6CACE,UAAM,CAER,kEACE,YAAQ,CAEV,oDACE,UAAM,CACN,kBAAW,CCtEb,wBACE,qCAAU,CACV,qBAAiB,CACjB,gCAAiB,CACjB,YAAQ,CACR,WAAO,CACP,MAAK,CACL,aAAS,CACT,cAAS,CACT,KAAI,CACJ,UAAM,CACN,kBAAQ,CAEV,2BACE,cAAU,CACV,eAAY,CACZ,aAAO,CAET,8CACE,wBAAO,CACP,uBAAM,CACN,iBAAc,CAEhB,gCACE,iCAAU,CACV,sBAAmB,CACnB,yBAAe,CACf,wBAAiB,CACjB,mEAAyC,CACzC,WAAO,CACP,eAAS,CACT,SAAQ,CAEV,wBACE,6BAAM,CACN,WAAM,CACN,cAAU,CACV,gBAAY,CAEd,0DAEE,UAAM,CACN,cAAO,CACP,oBAAgB,CAElB,+BACE,UAAM,CACN,gBAAQ,CAEV,6BACE,aAAS,CACT,YAAQ,CACR,cAAO,CAET,+BACE,UAAM,CACN,gBAAQ,CAGV,0BACE,kBAAW,CACX,YAAQ,CACR,cAAU,CACV,kBAAO,CACP,aAAS,CACT,oBAAQ,CAEV,oCACE,WAAQ,CAEV,6BACE,iBAAc,CACd,kCAAW,CACX,cAAO,CACP,UAAO,CACP,eAAS,CACT,WAAM,CAER,yEAEE,yBAAW,CAEb,qCACE,wBAAiB,CACjB,QAAO,CACP,eAAW,CACX,uBAAQ,CAEV,0BACE,YAAQ,CACR,WAAM,CAER,gCACE,aAAQ,CACR,YAAO,CACP,WAAM,CAER,iCACE,WAAM,CAER,yCACE,UAAM,CACN,oBAAQ,CACR,eAAU,CACV,eAAS,CACT,sBAAc,CACd,kBAAY,CAEd,yFAEE,qBAAiB,CAEnB,0CACE,UAAM,CACN,aAAQ,CACR,cAAW,CACX,eAAS,CACT,sBAAc,CACd,kBAAY,CACZ,WAAM,CAER,mGAEE,UAAM,CAER,gDACE,qBAAM,CAER,+BACE,uBAAW,CAAX,oBAAW,CAAX,eAAW,CACX,eAAc,CACd,eAAW,CACX,cAAO,CACP,oBAAQ,CACR,cAAU,CACV,eAAY,CACZ,iBAAO,CACP,gBAAQ,CAEV,oCACE,YAAQ,CAEV,+BACE,wBAAiB,CACjB,WAAO,CACP,UAAM,CACN,iBAAc,CACd,eAAY,CACZ,gBAAQ,CACR,yBAAe,CAEjB,yEAEE,wBAAiB,CACjB,4BAAY,CAEd,2EAEE,wBAAiB,CACjB,4BAAY,CAEd,uCACE,qBAAiB,CACjB,WAAO,CAET,2BACE,wBAAiB,CACjB,aAAM,CACN,YAAQ,CACR,cAAU,CACV,6BAAgB,CAChB,eAAW,CACX,aAAS,CACT,WAAQ,CACR,iBAAc,CAEhB,iCACE,UAAM,CACN,eAAQ,CAEV,yCACE,eAAY,CAEd,8BACE,iBAAc,CAEhB,iDACE,YAAQ,CAEV,gCACE,iBAAS,CACT,eAAW,CACX,WAAM,CAER,oCACE,iBAAS,CACT,OAAM,CACN,OAAI,CAEN,oCACE,WAAO,CAET,yCACE,gBAAY,CACZ,WAAQ,CAEV,8CACE,cAAQ,CAEV,8CACE,eAAY,CACZ,WAAM,CAER,iCACE,uCAAO,CACP,iBAAc,CACd,cAAO,CP1LT,8FACE,gBAAU,CACV,sBAAY,CAGd,iCACE,oBAAS,CACT,UAAQ,CACR,gBAAU,CACV,sBAAgB,CQrClB,8BACE,kBAAY,CACZ,wBAAiB,CACjB,aAAM,CACN,iBAAS,CACT,OAAM,CACN,KAAI,CACJ,WAAU,CACV,YAAQ,CACR,WAAO,CACP,cAAU,CACV,6BAAgB,CAChB,aAAO,CACP,WAAM,CAEN,kDACE,YAAQ,CACR,WAAO,CACP,WAAM,CACN,6BAAgB,CAElB,mDACE,YAAQ,CACR,WAAO,CACP,WAAM,CACN,kBAAY,CACZ,wBAAgB,CAEpB,8BACE,eAAQ,CACR,cAAO,CAEP,gCACE,QAAO,CACP,cAAU,CAEd,8BACE,YAAQ,CACR,kBAAY,CACZ,WAAO,CAEP,sCACE,UAAM,CACN,WAAO,CACP,QAAO,CACP,eAAW,CACX,cAAU,CACV,cAAO,CAET,4CACE,kBAAW,CAEX,gDACE,UAAM,CAEZ,iCACE,YAAQ,CACR,kBAAY,CACZ,WAAO,CAEP,mCACE,wBAAY,CACZ,qBAAe,CACf,WAAO,CACP,YAAQ,CACR,kBAAY,CAGZ,8CACE,YAAQ,CAEV,iEACE,wBAAiB,CAErB,6CACE,mCAAiB,CACjB,UAAM,CAER,mDACE,qBAAM,CAEV,kCACE,iBAAa,CACb,kBAAc,CAEhB,wCACE,UAAM,CACN,gBAAa,CACb,cAAU,CAEZ,2CACE,aAAY,CAEd,+BACE,cAAO,CACP,WAAM,CACN,2DACE,gBAAa,CACb,iBAAc,CAElB,gCACE,gBAAa,CACb,kBAAY,CACZ,YAAQ,CACR,wBAAiB,CACjB,iBAAc,CACd,WAAO,CACP,kCACE,iBAAa,CACf,iDACE,eAAW,CACb,sDACE,aAAM,CACN,cAAU,CACV,4DACE,UAAM,CAEZ,8BACE,YAAQ,CRhGiB,0BAAA,8BQkGvB,aAAQ,CAAA,CR5FZ,8FACE,gBAAU,CACV,sBAAY,CAGd,iCACE,oBAAS,CACT,UAAQ,CACR,gBAAU,CACV,sBAAgB,CSrClB,iCACE,gCAAiB,CACjB,WAAO,CACP,eAAc,CACd,UAAM,CACN,sBAAY,CAEd,oCACE,WAAO,CAET,gDACE,gCAAiB,CACjB,aAAM,CAER,gCACE,gCAAiB,CAEnB,gCACE,oBAAQ,CACR,UAAM,CACN,iBAAc,CAEhB,sGAEE,qBAAM,CAER,qCACE,qBAAM,CAGR,0BACE,WAAO,CACP,aAAM,CACN,cAAO,CAET,2BACE,oBAAQ,CACR,iBAAS,CAEX,mCACE,wBAAiB,CACjB,uCAAW,CACX,YAAQ,CACR,QAAK,CACL,cAAU,CACV,iBAAS,CACT,WAAQ,CAEV,qCACE,wBAAiB,CACjB,aAAM,CACN,aAAQ,CACR,iBAAQ,CACR,oBAAgB,CAElB,2CACE,wBAAiB,CACjB,aAAM,CAER,kDACE,aAAQ,CAEV,yCACE,UAAM,CAER,+BACE,YAAQ,CACR,6BAAgB,CAChB,kBAAY,CR3CZ,6IAME,4FAAY,CACZ,cAAU,CAEZ,mSAME,yEAAuB,CAEzB,oBACE,QAAO,CACP,yBAAW,CAEb,mBACE,cAAO,CAET,wBACE,iBAAS,CAEX,sBACE,sIAAoB,CAEtB,0BACE,eAAS,CAAT,aAAS,CAAT,UAAS,CACT,eAAY,CACZ,gBAAU,CAEZ,kCACE,4BAAa,CAEf,+BACE,mCAAiB,CACjB,4BAAa,CAEf,iDAEE,YAAQ,CAEV,+BACE,sBAAW,CACX,cAAQ,CACR,WAAO,CACP,QAAK,CACL,aAAQ,CACR,iBAAS,CACT,OAAI,CACJ,uBAAe,CACf,UAAM,CAER,0DAEE,UAAQ,CAEV,+EAGI,cAAO,CACP,wBAAY,CAAZ,qBAAY,CAAZ,gBAAY,CAEhB,+BACE,YAAQ,CACR,kBAAe,CACf,iBAAS,CACT,QAAO,CACP,UAAQ,CACR,wBAAM,CACN,WAAO,CACP,kBAAW,CACX,iBAAa,CAEf,kDACE,mBAAe,CACf,gBAAY,CACZ,gBAAU,CACV,cAAQ,CACR,iBAAW,CACX,kBAAW,CACX,aAAM,CACN,eAAY,CAEd,mDACE,YAAQ,CAEV,8BACE,wBAAiB,CACjB,sBAAW,CACX,UAAM,CACN,cAAU,CACV,MAAK,CACL,kBAAY,CACZ,QAAO,CACP,cAAS,CACT,iBAAW,CACX,oBAAgB,CAChB,QAAO,CACP,OAAM,CACN,QAAO,CACP,SAAQ,CACR,YAAQ,CACR,kBAAY,CACZ,sBAAgB,CAChB,UAAQ,CACR,eAAY,CACZ,4BAAW,CAEb,oCACE,wBAAiB,CACjB,UAAM,CAEN,wCACE,UAAM,CAEV,4DAEE,wBAAiB,CACjB,UAAM,CACN,WAAO,CACP,YAAQ,CACR,kBAAY,CACZ,sBAAgB,CAChB,QAAO,CACP,cAAU,CACV,eAAY,CACZ,cAAO,CAET,wEAEE,wBAAiB,CAEnB,+BACE,WAAM,CAER,+BACE,WAAM,CAER,uBACE,qBAAO,CACP,UAAM,CAER,wDAEE,8FAA4C,CAE9C,kIAIE,eAAW,CACX,YAAQ,CAEV,wCACE,uBAAW,CAAX,oBAAW,CAAX,eAAW,CACX,cAAO,CACP,QAAO,CACP,WAAO,CACP,UAAM,CAER,8CACE,eAAW,CAEb,8BACE,QAAO,CACP,qBAAM,CACN,iBAAO,CACP,cAAU,CACV,WAAQ,CAEV,sEAEE,wBAAO,CACP,UAAM,CACN,WAAO,CAET,6BACE,qBAAO,CAET,0BACE,kBAAW,CACX,WAAM,CAER,4BACE,qBAAe,CAEjB,yEAGE,eAAW,CACX,4BAAO,CACP,UAAM,CAER,wBACE,kBAAW,CAEb,mCACE,qBAAiB,CACjB,qBAAO,CACP,WAAO,CACP,cAAO,CAET,mCACE,cAAO,CACP,WAAO,CACP,SAAQ,CACR,UAAM,CAGR,uDACE,QAAO,CAET,+DACE,SAAQ,CAEV,oDACE,QAAO,CAET,mDACE,QAAO,CACP,SAAQ,CAEV,yBACE,iBAAW,CAEb,0BACE,aAAM,CACN,cAAU,CACV,eAAY,CACZ,YAAQ,CACR,kBAAY,CACZ,sBAAgB,CAChB,oBAAgB,CAElB,+BACE,aAAM,CAMR,uBACE,YAAQ,CAEV,0CACE,eAAO,CAET,6BACE,mBAAY,CACZ,YAAQ,CACR,wBAAgB,CAChB,yBAAO,CACP,aAAY,CACZ,eAAc,CACd,iBAAS,CACT,OAAM,CACN,QAAI,CAEN,qCACE,YAAQ,CACR,6BAAgB,CAChB,MAAK,CACL,WAAO,CACP,mBAAe,CACf,cAAS,CACT,KAAI,CACJ,UAAM,CACN,UAAQ,CAEV,wFAGE,kBAAe,CAEjB,4DACE,wBAAiB,CACjB,YAAQ,CAEV,iCACE,kBAAY,CACZ,YAAQ,CACR,WAAO,CACP,iBAAS,CACT,UAAQ,CAER,mCACE,wBAAiB,CACjB,aAAM,CACN,WAAQ,CACR,UAAQ,CAEV,yCACE,wBAAiB,CACjB,UAAM,CAEV,sCACE,KAAI,CACJ,MAAK,CAEP,uCACE,KAAI,CACJ,OAAM,CAhER,0BACE,KAAO,SAAS,CAChB,GAAK,SAAS,CAAA',
            sourcesContent: [
      ...
      181: (e, t, n) => {
        ...
        e.exports = function (e, t, n) {
          ...
          function C(e) {
            return (s = void 0), b && r ? v(e) : ((r = o = void 0), a);
          }
          function w() {
            var e = m(),
              n = g(e);
            if (((r = arguments), (o = this), (l = e), n)) {
              if (void 0 === s)
                return (function (e) {
                  return (c = e), (s = setTimeout(A, t)), u ? v(e) : a;
                })(l);
              if (p) return (s = setTimeout(A, t)), v(l);
            }
      ...
      551: (e, t, n) => {
        ...
        function Ve(e, t, n, r, o, i, a, s, l) {
          (Ne = !1), (Le = null), Be.apply(De, arguments);
        }
        function He(e) {
          var t = e,
            n = e;
        ...
        function Ht(e) {
          ...
          for (; 0 < It.length && null === (n = It[0]).blockedOn; )
            Lt(n), null === n.blockedOn && It.shift();
        }
        ...
        function $t(e, t, n, r) {
          if (Wt) {
            var o = Gt(e, t, n, r);
            if (null === o) Wr(e, t, r, Xt, n), Bt(e, r);
            else if (
              (function (e, t, n, r, o) {
                switch (t) {
                  case 'focusin':
                  ...
                  case 'pointerover':
                    var i = o.pointerId;
                    return Rt.set(i, Nt(Rt.get(i) || null, e, t, n, r, o)), !0;
                  case 'gotpointercapture':
                    return (
                      (i = o.pointerId),
                      Mt.set(i, Nt(Mt.get(i) || null, e, t, n, r, o)),
                      !0
                    );
                }
                return !1;
              ...
              r.stopPropagation();
            else if ((Bt(e, r), 4 & t && -1 < _t.indexOf(e))) {
              for (; null !== o; ) {
                var i = Ao(o);
                if (
                  (null !== i && Ct(i),
                  null === (i = Gt(e, t, n, r)) && Wr(e, t, r, Xt, n),
                  i === o)
                )
                  break;
                o = i;
        ...
        var Sn = L({}, pn, {
          ...
          Mn = on(Rn),
          In = [9, 13, 27, 32],
          _n = u && 'CompositionEvent' in window,
          Bn = null;
        u && 'documentMode' in document && (Bn = document.documentMode);
        var Nn = u && 'TextEvent' in window && !Bn,
          Ln = u && (!_n || (Bn && 8 < Bn && 11 >= Bn)),
            ...
            if (0 == (7 & t)) {
              if (
                ...
                if (
                  ...
                  e: {
                    for (f = c, m = 0, d = u = l; d; d = $r(d)) m++;
                    for (d = 0, h = f; h; h = $r(h)) d++;
                    for (; 0 < m - d; ) (u = $r(u)), m--;
                    for (; 0 < d - m; ) (f = $r(f)), d--;
                    for (; m--; ) {
              ...
              g &&
                (Ln &&
                  ...
                  (Hn || 'onCompositionStart' !== g
                    ? 'onCompositionEnd' === g && Hn && (v = en())
                    : ((Kt = 'value' in (Zt = o) ? Zt.value : Zt.textContent),
                      (Hn = !0))),
                0 < (b = Qr(r, g)).length &&
                  ((g = new An(g, e, null, n, o)),
                  a.push({ event: g, listeners: b }),
                  (v || null !== (v = Vn(n))) && (g.data = v))),
                (v = Nn
                  ? (function (e, t) {
                      switch (e) {
                        case 'compositionend':
        ...
        function Qr(e, t) {
          for (var n = t + 'Capture', r = []; null !== e; ) {
            ...
            5 === o.tag &&
              null !== i &&
              ((o = i),
              null != (i = Me(e, n)) && r.unshift(Yr(e, i, o)),
              null != (i = Me(e, t)) && r.push(Yr(e, i, o))),
              (e = e.return);
          }
          return r;
        }
        ...
        function Xr(e, t, n, r, o) {
          for (var i = t._reactName, a = []; null !== n && n !== r; ) {
            ...
            5 === s.tag &&
              ...
              ((s = c),
              o
                ? null != (l = Me(n, i)) && a.unshift(Yr(n, l, s))
                : o || (null != (l = Me(n, i)) && a.push(Yr(n, l, s)))),
              (n = n.return);
          }
        ...
        function Uo() {
          if (!Vo && null !== Fo) {
            ...
            try {
              ...
              throw (null !== Fo && (Fo = Fo.slice(e + 1)), $e(Je, Uo), t);
            } finally {
              (gt = t), (Vo = !1);
            }
          }
        ...
        var Wo = [],
          ...
          Ko = '';
        function Jo(e, t) {
          (Wo[Yo++] = $o), (Wo[Yo++] = Qo), (Qo = e), ($o = t);
        }
        function ei(e, t, n) {
          (Xo[Go++] = Zo), (Xo[Go++] = Ko), (Xo[Go++] = qo), (qo = e);
          var r = Zo;
          e = Ko;
          var o = 32 - at(r) - 1;
          (r &= ~(1 << o)), (n += 1);
        ...
        function ni(e) {
          for (; e === Qo; )
            (Qo = Wo[--Yo]), (Wo[Yo] = null), ($o = Wo[--Yo]), (Wo[Yo] = null);
          for (; e === qo; )
            (qo = Xo[--Go]),
              (Xo[Go] = null),
              (Ko = Xo[--Go]),
          ...
          switch (e.tag) {
            ...
            case 13:
              return (
                ...
                ((n = null !== qo ? { id: Zo, overflow: Ko } : null),
                (e.memoizedState = {
                  dehydrated: t,
                  treeContext: n,
        ...
        function Si(e) {
          ...
          if (Ci !== e)
            if (
              ...
              (Ai = e), (gi.dependencies = { lanes: 0, firstContext: e });
            } else Ai = Ai.next = e;
          return t;
        }
        var ki = null;
        ...
        var Hi = {
          ...
          enqueueSetState: function (e, t, n) {
            ...
            (i.payload = t),
              null != n && (i.callback = n),
              null !== (t = Bi(e, i, o)) && (rc(t, e, o, r), Ni(t, e, o));
          },
          ...
          enqueueForceUpdate: function (e, t) {
            ...
            (o.tag = 2),
              null != t && (o.callback = t),
              null !== (t = Bi(e, o, r)) && (rc(t, e, r, n), Ni(t, e, r));
          }
        };
        ...
        function Qi(e, t, n, r) {
          ...
          'object' == typeof i && null !== i
            ? (o.context = Si(i))
            : ((i = Io(t) ? Ro : jo.current), (o.context = Mo(e, i))),
        ...
        function qi(e) {
          ...
          function c(e, t, n, r) {
            ...
            return i === x
              ...
              : null !== t &&
                ...
                : (((r = Bc(n.type, n.key, n.props, null, e.mode, r)).ref = $i(
                    e,
                    t,
                    n
                  )),
          ...
          function f(e, t, n) {
            ...
            if ('object' == typeof t && null !== t) {
              switch (t.$$typeof) {
                case C:
                  return (
                    ((n = Bc(t.type, t.key, t.props, null, e.mode, n)).ref = $i(
                      e,
                      null,
                      t
                    )),
          ...
          function d(e, t, n, r) {
            ...
            if ('object' == typeof n && null !== n) {
              ...
              if (te(n) || B(n)) return null !== o ? null : p(e, t, n, r, null);
              Xi(e, n);
            }
            return null;
          }
          ...
          function y(o, s, l, c) {
            ...
            for (
              var p = (u = null), h = s, y = (s = 0), b = null, v = l.next();
              null !== h && !v.done;
              y++, v = l.next()
            ) {
              h.index > y ? ((b = h), (h = null)) : (b = h.sibling);
              var g = d(o, h, v.value, c);
              if (null === g) {
                null === h && (h = b);
                break;
              }
            ...
            if (v.done) return n(o, h), ii && Jo(o, y), u;
            if (null === h) {
              ...
              switch (a.$$typeof) {
                case C:
                  e: {
                    ...
                    a.type === x
                      ? (((i = Nc(a.props.children, r.mode, l, a.key)).return =
                          r),
                        (r = i))
                      : (((l = Bc(
                          a.type,
        ...
        function Ea(e, t, n, r, o, a) {
          if (
            ...
            a = 0;
            do {
              if (((ga = !1), (Aa = 0), 25 <= a)) throw Error(i(301));
              (a += 1),
                (ba = ya = null),
                (t.updateQueue = null),
                (fa.current = cs),
        ...
        function ja(e) {
          ...
          if (null !== (e = n.interleaved)) {
            o = e;
            do {
              (a = o.lane), (ha.lanes |= a), (Ll |= a), (o = o.next);
            } while (o !== e);
        ...
        function Ma(e, t) {
          ...
          if (
            ...
            if (
              ((n.flags |= 2048),
              Fa(9, _a.bind(null, n, r, o, t), void 0, null),
              null === Pl)
            )
              throw Error(i(349));
            0 != (30 & ma) || Ia(n, t, o);
        ...
        function Ha(e, t, n, r) {
          ...
          (ha.flags |= e), (o.memoizedState = Fa(1 | t, n, i, r));
        }
        function Ua(e, t) {
        ...
        function Ka(e, t, n) {
          return 0 == (21 & ma)
            ? (e.baseState && ((e.baseState = !1), (As = !0)),
              (e.memoizedState = n))
            : (sr(n, t) ||
                ((n = ht()), (ha.lanes |= n), (Ll |= n), (e.baseState = !0)),
              t);
        }
        function Ja(e, t) {
          var n = gt;
        ...
        var as = {
          ...
          ss = {
            ...
            useImperativeHandle: function (e, t, n) {
              return (
                (n = null != n ? n.concat([e]) : null),
                Va(4194308, 4, $a.bind(null, t, e), n)
              );
            },
            ...
            useSyncExternalStore: function (e, t, n) {
              ...
              return (
                (o.queue = a),
                Ua(Ba.bind(null, r, a, e), [e]),
                (r.flags |= 2048),
                Fa(9, _a.bind(null, r, a, n, t), void 0, null),
                n
              );
            },
            useId: function () {
          ...
          ls = {
            ...
            useTransition: function () {
              return [ja(Ta)[0], ka().memoizedState];
            },
            useMutableSource: Ra,
          ...
          cs = {
            ...
            useTransition: function () {
              return [Pa(Ta)[0], ka().memoizedState];
            },
            useMutableSource: Ra,
            useSyncExternalStore: Ma,
            useId: es,
            ...
            ? (e === t
                ...
                : ((e.flags |= 128),
                  ...
                  1 === n.tag &&
                    (null === n.alternate
                      ? (n.tag = 17)
                      : (((t = _i(-1, 1)).tag = 2), Bi(n, t, 1))),
                  (n.lanes |= 1)),
              e)
            : ((e.flags |= 65536), (e.lanes = o), e);
        }
        var gs = A.ReactCurrentOwner,
          As = !1;
        function Cs(e, t, n, r) {
        ...
        function Ts(e, t, n, r, o) {
          ...
          if ((Oi(t, o), null === t.stateNode))
            Ws(e, t), Wi(t, n, r), Qi(t, n, r, o), (r = !0);
          else if (null === e) {
            var a = t.stateNode,
              s = t.memoizedProps;
            a.props = s;
            ...
            s !== p || f !== m || Po.current || Ri
              ? ('function' == typeof d &&
                  (Vi(t, n, d, r), (m = t.memoizedState)),
                (c = Ri || Ui(t, n, c, r, f, m, l) || !1)
                  ? (u ||
        ...
        function js(e, t, n, r, o, i) {
          Ss(e, t);
          var a = 0 != (128 & t.flags);
          if (!r && !a) return o && zo(t, n, !1), Ys(e, t, i);
        ...
        function zs(e, t, n) {
          ...
          if (null !== (a = e.memoizedState) && null !== (r = a.dehydrated))
            return (function (e, t, n, r, o, a, s) {
              if (n)
                return 256 & t.flags
                  ? ((t.flags &= -257), Ds(e, t, s, (r = ps(Error(i(422))))))
              ...
              if ('$!' === o.data) {
                if ((r = o.nextSibling && o.nextSibling.dataset))
                  var l = r.dgst;
                return (
                  (r = l), Ds(e, t, s, (r = ps((a = Error(i(419))), r, void 0)))
                );
              }
              if (((l = 0 != (s & e.childLanes)), As || l)) {
                ...
                return yc(), Ds(e, t, s, (r = ps(Error(i(421)))));
              }
              return '$?' === o.data
                ? ((t.flags |= 128),
                  (t.child = e.child),
            ...
            return (
              0 == (1 & l) && t.child !== a
                ? (((o = t.child).childLanes = 0),
                  (o.pendingProps = c),
                  (t.deletions = null))
                : ((o = _c(a, c)).subtreeFlags = 14680064 & a.subtreeFlags),
              null !== r
                ? (s = _c(r, s))
          ...
          return (
            (e = (s = e.child).sibling),
            (o = _c(s, { mode: 'visible', children: o.children })),
        ...
        function Xs(e, t, n) {
          ...
          switch ((ni(t), t.tag)) {
            ...
            case 5:
              ...
              return $s(t), null;
            case 6:
              if (e && null != t.stateNode) Bs(e, t, e.memoizedProps, r);
              else {
            ...
            case 19:
              if ((So(la), null === (a = t.memoizedState))) return $s(t), null;
        ...
        var El,
          ...
          ec = 0;
        function tc() {
          return 0 != (6 & jl) ? Ze() : -1 !== Jl ? Jl : (Jl = Ze());
        }
        function nc(e) {
          return 0 == (1 & e.mode)
            ? 1
        ...
        function rc(e, t, n, r) {
          if (50 < Zl) throw ((Zl = 0), (Kl = null), Error(i(185)));
          bt(e, n, r),
            (0 != (2 & jl) && e === Pl) ||
              (e === Pl && (0 == (2 & jl) && (zl |= n), 4 === Bl && lc(e, Ml)),
              oc(e, r),
              1 === n &&
                0 === jl &&
                0 == (1 & t.mode) &&
        ...
        function ic(e, t) {
          ...
          var r = ft(e, e === Pl ? Ml : 0);
          if (0 === r) return null;
          if (0 != (30 & r) || 0 != (r & e.expiredLanes) || t) t = bc(e, r);
          else {
            t = r;
            var o = jl;
            jl |= 2;
          ...
          if (0 !== t) {
            if (
              ...
              throw ((n = Nl), dc(e, 0), lc(e, r), oc(e, Ze()), n);
            if (6 === t) lc(e, r);
            else {
              if (
              ...
              switch (((e.finishedWork = o), (e.finishedLanes = r), t)) {
                ...
                case 3:
                  if (
                    ...
                    e.timeoutHandle = ro(wc.bind(null, e, Vl, Wl), t);
                    break;
                  }
                  wc(e, Vl, Wl);
                  break;
                case 4:
                  ...
                  if (
                    ...
                    e.timeoutHandle = ro(wc.bind(null, e, Vl, Wl), r);
                    break;
                  }
                  wc(e, Vl, Wl);
                  break;
          ...
          return oc(e, Ze()), e.callbackNode === n ? ic.bind(null, e) : null;
        }
        function ac(e, t) {
          var n = Dl;
          return (
            e.current.memoizedState.isDehydrated && (dc(e, t).flags |= 256),
            2 !== (e = bc(e, t)) && ((t = Vl), (Vl = n), null !== t && sc(t)),
            e
          );
        }
        function sc(e) {
        ...
        function cc(e) {
          ...
          xc();
          var t = ft(e, 0);
          if (0 == (1 & t)) return oc(e, Ze()), null;
          var n = bc(e, t);
          if (0 !== e.tag && 2 === n) {
            var r = mt(e);
            0 !== r && ((t = r), (n = ac(e, r)));
          }
          if (1 === n) throw ((n = Nl), dc(e, 0), lc(e, t), oc(e, Ze()), n);
        ...
        function uc(e, t) {
          ...
          try {
            ...
            0 === (jl = n) && ((Ul = Ze() + 500), Do && Uo());
          }
        }
        function pc(e) {
          null !== Gl && 0 === Gl.tag && 0 == (6 & jl) && xc();
          var t = jl;
          jl |= 1;
          var n = Tl.transition,
            r = gt;
          try {
            if (((Tl.transition = null), (gt = 1), e)) return e();
          } finally {
            (gt = r), (Tl.transition = n), 0 == (6 & (jl = t)) && Uo();
          }
        }
        function fc() {
          (Il = _l.current), So(_l);
        ...
        function dc(e, t) {
          ...
          if ((-1 !== n && ((e.timeoutHandle = -1), oo(n)), null !== Rl))
            for (n = Rl.return; null !== n; ) {
              ...
              switch ((ni(r), r.tag)) {
                case 1:
                  null != (r = r.type.childContextTypes) && _o();
                  break;
                case 3:
                  ia(), So(Po), So(jo), pa();
                  break;
        ...
        function bc(e, t) {
          ...
          if ((wi(), (jl = n), (Sl.current = r), null !== Rl))
            throw Error(i(261));
          return (Pl = null), (Ml = 0), Bl;
        }
        function vc() {
          for (; null !== Rl; ) Ac(Rl);
        }
        function gc() {
          for (; null !== Rl && !Ge(); ) Ac(Rl);
        }
        function Ac(e) {
        ...
        function Cc(e) {
          ...
          do {
            ...
            if (((e = t.return), 0 == (32768 & t.flags))) {
              if (null !== (n = Xs(n, t, Il))) return void (Rl = n);
            } else {
              if (null !== (n = Gs(n, t)))
                return (n.flags &= 32767), void (Rl = n);
              if (null === e) return (Bl = 6), void (Rl = null);
          ...
          try {
            (Tl.transition = null),
              ...
              (function (e, t, n, r) {
                ...
                if (Yl) throw ((Yl = !1), (e = Ql), (Ql = null), e);
                0 != (1 & ql) && 0 !== e.tag && xc(),
        ...
        function xc() {
          if (null !== Gl) {
            var e = At(ql),
              ...
              n = gt;
            try {
              if (((Tl.transition = null), (gt = 16 > e ? 16 : e), null === Gl))
                var r = !1;
              else {
                if (((e = Gl), (Gl = null), (ql = 0), 0 != (6 & jl)))
                  throw Error(i(331));
                var o = jl;
              ...
              (gt = n), (Tl.transition = t);
            }
          }
          return !1;
        }
        function Ec(e, t, n) {
          (e = Bi(e, (t = ms(0, (t = us(n, t)), 1)), 1)),
            (t = tc()),
        ...
        function Sc(e, t, n) {
          ...
          null !== r && r.delete(t),
            ...
            Pl === e &&
              (Ml & n) === n &&
              (4 === Bl ||
              (3 === Bl && (130023424 & Ml) === Ml && 500 > Ze() - Hl)
                ? dc(e, 0)
                : (Fl |= n)),
            oc(e, t);
        }
        ...
        function Bc(e, t, n, r, o, a) {
          ...
          if (((r = e), 'function' == typeof e)) Ic(e) && (s = 1);
            ...
            e: switch (e) {
              ...
              case O:
                return (
                  ((e = Mc(12, n, t, 2 | o)).elementType = O), (e.lanes = a), e
                );
              case j:
                return (
                  ((e = Mc(13, n, t, o)).elementType = j), (e.lanes = a), e
                );
              case P:
                return (
                  ((e = Mc(19, n, t, o)).elementType = P), (e.lanes = a), e
                );
              case I:
                return Lc(n, o, a, t);
              default:
        ...
        function Uc(e, t, n, r, o, i, a, s, l) {
          return (
            ((e = Vc(n, r, !0, e, 0, i, 0, s, l)).context = Hc(null)),
            (n = e.current),
            ((i = _i((r = tc()), (o = nc(n)))).callback = null != t ? t : null),
            Bi(n, i, o),
            (e.current.lanes = o),
            bt(e, o, r),
            oc(e, r),
        ...
        function Wc(e, t, n, r) {
          ...
          return (
            ...
            null !== (e = Bi(o, t, a)) && (rc(e, o, a, i), Ni(e, o, a)),
            a
          );
        }
        function Yc(e) {
        ...
        El = function (e, t, n) {
          if (null !== e)
            if (e.memoizedProps !== t.pendingProps || Po.current) As = !0;
            else {
                  ...
                  (function (e, t, n) {
                    switch (t.tag) {
                      ...
                      case 10:
                        ...
                        ko(vi, r._currentValue), (r._currentValue = o);
                        break;
                      case 13:
          ...
          else (As = !1), ii && 0 != (1048576 & t.flags) && ei(t, $o, t.index);
          switch (((t.lanes = 0), t.tag)) {
            ...
            case 4:
              return (
                oa(t, t.stateNode.containerInfo),
                (r = t.pendingProps),
                null === e ? (t.child = Zi(t, null, r, n)) : Cs(e, t, r, n),
                t.child
              );
            case 11:
              return (
      ...
      287: (e, t) => {
        ...
        var A = (g.prototype = new v());
        (A.constructor = g), h(A, b.prototype), (A.isPureReactComponent = !0);
        var C = Array.isArray,
        ...
        function C(e) {
          if (((y = !1), A(e), !h))
            if (null !== r(c)) (h = !0), I(w);
              ...
              var t = r(u);
              null !== t && _(C, t.startTime - e);
            }
        }
        function w(e, n) {
          (h = !1), y && ((y = !1), v(S), (S = -1)), (m = !0);
          var i = d;
          try {
            for (
              A(n), f = r(c);
            ...
            return (
              ...
              i > a
                ? ((e.sortIndex = i),
                  ...
                  null === r(c) &&
                    e === r(u) &&
                    (y ? (v(S), (S = -1)) : (y = !0), _(C, i - a)))
                : ((e.sortIndex = s), n(c, e), h || m || ((h = !0), I(w))),
              e
            );
          }),
    ...
    (() => {
      ...
      function r(e) {
        var r = (function (e) {
            ...
            r.setAttribute('id', 'aframeInspectorMouseCursor'),
              r.setAttribute('raycaster', {
                interval: 100,
                objects: 'a-scene :not([data-aframe-inspector])'
              }),
              r.setAttribute('cursor', 'rayOrigin', 'mouse'),
              r.setAttribute('data-aframe-inspector', 'true');
            var o = r.components.raycaster,
              i = o.refreshObjects;
            (o.refreshObjects = function () {
              ...
              e.sceneEl.appendChild(r),
              (e.cursor = r),
              r.addEventListener('click', function (t) {
                0 === a.distanceTo(s) && e.selectEntity(t.detail.intersectedEl);
              }),
              r.addEventListener('mouseenter', function () {
                t.A.emit(
                  'raycastermouseenter',
                  r.components.cursor.intersectedEl
                );
              }),
              ...
              e.container.addEventListener('mousedown', l),
              e.container.addEventListener('mouseup', c),
              e.container.addEventListener('dblclick', u),
            ...
            function l(t) {
              if (!(t instanceof CustomEvent)) {
                t.preventDefault();
                var r = n(e.container, t.clientX, t.clientY);
                a.fromArray(r);
              }
            }
            function c(t) {
            ...
            function u(e) {
              var n = r.components.cursor.intersectedEl;
              n && t.A.emit('objectfocus', n.object3D);
            }
            return {
              el: r,
              enable: function () {
                r.setAttribute('raycaster', 'enabled', !0),
                  e.container.addEventListener('mousedown', l),
                  e.container.addEventListener('mouseup', c),
                  e.container.addEventListener('dblclick', u);
              },
              disable: function () {
                r.setAttribute('raycaster', 'enabled', !1),
                  e.container.removeEventListener('mousedown', l),
                  e.container.removeEventListener('mouseup', c),
                  e.container.removeEventListener('dblclick', u);
              }
            };
          })(e),
          o = e.sceneEl;
        ...
        var i = e.sceneHelpers,
          a = new THREE.GridHelper(30, 60, 11184810, 2500134);
        i.add(a);
        var s = new THREE.BoxHelper();
        function l(t) {
        ...
        (s.material.depthTest = !1),
          ...
          s.material.color.set(2075378),
          (s.visible = !1),
          i.add(s);
        var c = e.camera,
          u = new THREE.TransformControls(c, e.container);
        (u.size = 0.75),
          u.addEventListener('objectChange', function (e) {
            var n = u.object;
            if (void 0 !== n) {
              var r, o;
              if ((s.setFromObject(n), l(n), 'translate' === e.mode))
                (r = 'position'),
                  (o = ''
                    .concat(n.position.x, ' ')
                    .concat(n.position.y, ' ')
          ...
          t.A.on('entityupdate', function (t) {
            ...
            e.selected === n &&
              e.selectedEntity.object3DMap.mesh &&
              s.setFromObject(e.selected);
          });
        var p = new THREE.EditorControls(c, e.container);
        function f() {
          r.enable(), u.activate(), (p.enabled = !0);
        }
        function d() {
          if (e.opened) {
            var t = e.camera,
              n = e.container.offsetWidth / e.container.offsetHeight;
            if (t.isPerspectiveCamera) t.aspect = n;
            else if (t.isOrthographicCamera) {
              var r = t.top - t.bottom;
              (t.left = (-r * n) / 2),
                (t.right = (r * n) / 2),
                (t.top = r / 2),
                (t.bottom = -r / 2);
            }
            p.setAspectRatio(n), t.updateProjectionMatrix();
            var o = e.helpers[t.uuid];
            o && o.update();
          }
        }
        p.center.set(0, 1.6, 0),
          (p.rotationSpeed = 0.0035),
          (p.zoomSpeed = 0.05),
          p.setAspectRatio(o.canvas.width / o.canvas.height),
          p.addEventListener('change', function () {
            u.update(!0), t.A.emit('camerachanged');
          }),
          t.A.on('cameratoggle', function (e) {
            p.setCamera(e.camera), u.setCamera(e.camera), d();
          }),
          f(),
            ...
            (s.visible = !1),
              ...
              e &&
                ...
                (e.el.getObject3D('mesh')
                  ? (s.setFromObject(e), (s.visible = !0))
                  : e.el.hasAttribute('gltf-model') &&
                    e.el.addEventListener('model-loaded', function t(n) {
                      n.target === e.el &&
                        (s.setFromObject(e),
                        (s.visible = !0),
                        e.el.removeEventListener('model-loaded', t));
                    }),
                u.attach(e));
          }),
          ...
          e.sceneEl.addEventListener('rendererresize', d),
      ...
      function l(e, t) {
        ...
        if (((n = Object.keys(e)), (r = Object.keys(t)), n.length !== r.length))
          return !1;
        for (var i = 0; i < n.length; i++) if (!l(e[n[i]], t[r[i]])) return !1;
        return !0;
      }
      function c(e, t) {
      ...
      function f(e, t) {
        if (
          ...
          e.parentNode.removeChild(e), AFRAME.INSPECTOR.selectEntity(n);
        }
      }
      function d(e) {
        e.flushToDOM();
                    ...
                    r = (
                      v(e.schema)
                        ? function () {
                            var r = h(e, null, t);
                            return (
                              void 0 === r && (r = y(e, null, t)),
                              void 0 !== r ? (n = !0) : (r = b(e, null)),
      ...
      a.prototype = {
        load: function () {
          var e = this,
            ...
            r = i + 'dist/images.json';
          n.open('GET', r),
            (n.onload = function () {
              var r = JSON.parse(n.responseText);
              (e.images = r.images),
                e.images.forEach(function (e) {
                  (e.fullPath = i + r.basepath.images + e.path),
                    (e.fullThumbPath =
                      i + r.basepath.images_thumbnails + e.thumbnail);
                }),
      ...
      var C = {
          ...
          onKeyUp: function (e) {
            if (A(e) && AFRAME.INSPECTOR.opened) {
              var n = e.keyCode;
              if (
                ...
                (8 !== n && 46 !== n) ||
                  (AFRAME.INSPECTOR.selectedEntity &&
                    f(AFRAME.INSPECTOR.selectedEntity, undefined)),
                68 === n &&
                  AFRAME.INSPECTOR.selectedEntity &&
                  d(AFRAME.INSPECTOR.selectedEntity),
                70 === n)
              ) {
          ...
          onKeyDown: function (e) {
            A(e) &&
              ...
              (((e.ctrlKey && 'macos' !== g) || (e.metaKey && 'macos' === g)) &&
                (AFRAME.INSPECTOR.selectedEntity &&
                  'INPUT' !== document.activeElement.tagName &&
                  (67 === e.keyCode &&
                    (AFRAME.INSPECTOR.entityToCopy =
                      AFRAME.INSPECTOR.selectedEntity),
                  86 === e.keyCode && d(AFRAME.INSPECTOR.entityToCopy)),
                83 === e.keyCode &&
                  (e.preventDefault(),
                  e.stopPropagation(),
                  ...
                  var e = (function (e) {
                      ...
                      return {
                        ...
                        icon: Array.isArray(r)
                          ...
                          : (0, z.jsx)('path', { fill: 'currentColor', d: r })
                      };
      ...
      function ze(e) {
        return (Ee = Oe = 1), (Se = Ce((je = e))), (ke = 0), [];
      }
      function Fe(e) {
        return (je = ''), e;
      }
      function De(e) {
        return ye(Ne(ke - 1, Ue(91 === e ? e + 2 : 40 === e ? e + 1 : e)));
      }
      function Ve(e) {
        for (; (Te = _e()) && Te < 33; ) Ie();
        return Le(e) > 2 || Le(Te) > 3 ? '' : ' ';
      }
      function He(e, t) {
        for (
          ;
        ...
        return Ne(e, Be() + (t < 6 && 32 == _e() && 32 == Ie()));
      }
      function Ue(e) {
        for (; Ie(); )
          switch (Te) {
      ...
      function We(e, t) {
        for (; Ie() && e + Te !== 57 && (e + Te !== 84 || 47 !== _e()); );
        return '/*' + Ne(t, ke - 1) + '*' + me(47 === e ? e : Ie());
      }
      function Ye(e) {
        for (; !Le(_e()); ) Ie();
        return Ne(e, ke);
      ...
      function et(e, t, n, r) {
        ...
        return Ce((n = Je(e.children, r)))
          ? (e.return = e.value + '{' + n + '}')
          : '';
      }
      function tt(e) {
        return Fe(nt('', null, null, null, [''], (e = ze(e)), 0, [0], e));
      }
      function nt(e, t, n, r, o, i, a, s, l) {
        for (
          ...
          switch (((m = v), (v = Ie()))) {
            case 40:
              if (108 != m && 58 == ge(x, p - 1)) {
                -1 != ve((x += be(De(v), '&', '&\f')), '&\f') && (b = -1);
                break;
              }
            case 34:
            case 39:
            ...
            case 0:
              switch (v) {
                ...
                default:
                  if (
                    (xe(
                      (w = rt(x, t, n, c, u, o, s, g, (A = []), (C = []), p)),
                      i
                    ),
                    123 === v)
                  )
                    if (0 === u) nt(x, t, w, w, A, i, p, s, C);
                    else
                      switch (99 === f && 110 === ge(x, 3) ? 100 : f) {
                        case 100:
                        case 109:
                        case 115:
                          nt(
            ...
            default:
              if (h < 1)
                if (123 == v) --h;
                else if (125 == v && 0 == h++ && 125 == Me()) continue;
              switch (((x += me(v)), v * h)) {
                case 38:
                  b = u > 0 ? 1 : ((x += '\f'), -1);
                  break;
      ...
      function rt(e, t, n, r, o, i, a, s, l, c, u) {
        for (
          var p = o - 1, f = 0 === o ? i : [''], d = we(f), m = 0, h = 0, y = 0;
          m < r;
          ++m
        )
          for (
            var b = 0, v = Ae(e, p + 1, (p = de((h = a[m])))), g = e;
            b < d;
            ++b
          )
            (g = ye(h > 0 ? f[b] + ' ' + v : be(v, /&\f/g, f[b]))) &&
              (l[y++] = g);
        return Pe(e, t, n, 0 === o ? qe : s, l, c, u);
      }
      function ot(e, t, n) {
        return Pe(e, t, n, Ge, me(Te), Ae(e, 2, -2), 0);
      }
      function it(e, t, n, r) {
        return Pe(e, t, n, Ze, Ae(e, 0, r), Ae(e, r + 1, -1), r);
      }
      var at = function (e, t, n) {
          for (
            var r = 0, o = 0;
            (r = o), (o = _e()), 38 === r && 12 === o && (t[n] = 1), !Le(o);
        ...
        lt = function (e) {
          if ('rule' === e.type && e.parent && !(e.length < 1)) {
            ...
            if (
              (1 !== e.props.length || 58 === t.charCodeAt(0) || st.get(n)) &&
              !r
            ) {
              st.set(e, !0);
              for (
        ...
        switch (
          ...
          case 5187:
            return (
              Xe +
              e +
              be(e, /(\w+).+(:[^]+)/, Xe + 'box-$1$2' + Qe + 'flex-$1$2') +
              e
            );
          case 5443:
            return Xe + e + Qe + 'flex-item-' + be(e, /flex-|-self/, '') + e;
          case 4675:
            return (
              Xe +
              e +
          ...
          case 5548:
            return Xe + e + Qe + be(e, 'shrink', 'negative') + e;
          case 5292:
            return Xe + e + Qe + be(e, 'basis', 'preferred-size') + e;
          case 6060:
            return (
              Xe +
              'box-' +
          ...
          case 6187:
            return (
              be(
                be(be(e, /(zoom-|grab)/, Xe + '$1'), /(image-set)/, Xe + '$1'),
                e,
                ''
              ) + e
            );
          ...
          case 4765:
            if (Ce(e) - 1 - t > 6)
              switch (ge(e, t + 1)) {
                ...
                case 115:
                  return ~ve(e, 'stretch')
                    ? ut(be(e, 'stretch', 'fill-available'), t) + e
                    : e;
              }
            break;
          case 4949:
            if (115 !== ge(e, t + 1)) break;
          case 6444:
            switch (ge(e, Ce(e) - 3 - (~ve(e, '!important') && 10))) {
              case 107:
                return be(e, ':', ':' + Xe) + e;
              case 101:
                return (
          ...
          case 5936:
            switch (ge(e, t + 11)) {
              case 114:
                return Xe + e + Qe + be(e, /[svh]\w+-[tblr]{2}/, 'tb') + e;
              case 108:
                return Xe + e + Qe + be(e, /[svh]\w+-[tblr]{2}/, 'tb-rl') + e;
              case 45:
                return Xe + e + Qe + be(e, /[svh]\w+-[tblr]{2}/, 'lr') + e;
            }
            return Xe + e + Qe + e + e;
        }
        return e;
          ...
          if (e.length > -1 && !e.return)
            switch (e.type) {
              case Ze:
                ...
                break;
              case Ke:
                return Je([Re(e, { value: be(e.value, '@', '@' + Xe) })], r);
              case qe:
                if (e.length)
                  return (function (e, t) {
                    return e.map(t).join('');
                      ...
                      case '::placeholder':
                        return Je(
                          [
                            Re(e, {
                              props: [
                                be(t, /:(plac\w+)/, ':' + Xe + 'input-$1')
                              ]
                            }),
                            Re(e, { props: [be(t, /:(plac\w+)/, ':-moz-$1')] }),
                            Re(e, {
                              props: [be(t, /:(plac\w+)/, Qe + 'input-$1')]
                            })
                          ],
                          r
                        );
      ...
      var yt = /[A-Z]|^ms/g,
        ...
        At = (function (e) {
          ...
          return function (e) {
            return (
              void 0 === t[e] &&
                (t[e] = vt((n = e)) ? n : n.replace(yt, '-$&').toLowerCase()),
              t[e]
            );
            var n;
          };
        ...
        Ct = function (e, t) {
          ...
          return 1 === ht[e] || vt(e) || 'number' != typeof t || 0 === t
            ? t
            : t + 'px';
        };
      function wt(e, t, n) {
        ...
        switch (typeof n) {
          ...
          case 'object':
            if (1 === n.anim)
              return (
                (xt = { name: n.name, styles: n.styles, next: xt }), n.name
              );
            if (void 0 !== n.styles) {
              var r = n.next;
              if (void 0 !== r)
                for (; void 0 !== r; )
                  (xt = { name: r.name, styles: r.styles, next: xt }),
                    (r = r.next);
              return n.styles + ';';
            }
            return (function (e, t, n) {
              var r = '';
              if (Array.isArray(n))
                for (var o = 0; o < n.length; o++) r += wt(e, t, n[o]) + ';';
              else
                for (var i in n) {
                  var a = n[i];
                  if ('object' != typeof a)
      ...
      var xt,
        ...
        Ot = function (e, t, n) {
          ...
          for (var a = 1; a < e.length; a++)
            (o += wt(n, t, e[a])), r && (o += i[a]);
          Et.lastIndex = 0;
          for (var s, l = ''; null !== (s = Et.exec(o)); ) l += '-' + s[1];
          return { name: mt(o) + l, styles: o, next: xt };
        },
        St =
          (!!x.useInsertionEffect && x.useInsertionEffect) ||
          function (e) {
            return e();
          },
        kt = {}.hasOwnProperty,
        Tt = (0, w.createContext)(
          'undefined' != typeof HTMLElement ? ft({ key: 'css' }) : null
        );
      Tt.Provider;
      var jt = function (e) {
          return (0, w.forwardRef)(function (t, n) {
            var r = (0, w.useContext)(Tt);
            return e(t, r, n);
          });
        },
        Pt = (0, w.createContext)({}),
        Rt = '__EMOTION_TYPE_PLEASE_DO_NOT_USE__',
        Mt = function (e) {
          var t = e.cache,
            n = e.serialized,
            r = e.isStringTag;
        ...
        It = jt(function (e, t, n) {
          ...
          var s = Ot(i, void 0, (0, w.useContext)(Pt));
          a += t.key + '-' + s.name;
          var l = {};
          for (var c in e)
            kt.call(e, c) && 'css' !== c && c !== Rt && (l[c] = e[c]);
          return (
            (l.ref = n),
            (l.className = a),
            (0, w.createElement)(
              w.Fragment,
              null,
              (0, w.createElement)(Mt, {
                cache: t,
                serialized: s,
                isStringTag: 'string' == typeof o
              }),
              (0, w.createElement)(o, l)
            )
          );
        });
      o(146);
      ...
      function Ft(e) {
        return Ut(e) ? (e.nodeName || '').toLowerCase() : '';
      }
      let Dt;
      function Vt(e) {
      ...
      function Gt(e) {
        const t =
          !Ht(e) && e.contextElement ? e.contextElement : Ht(e) ? e : null;
        if (!t) return Xt;
        ...
        if ('border-box' !== r.boxSizing)
          return Vt(t)
            ? {
                x: (t.offsetWidth > 0 && $t(n.width) / t.offsetWidth) || 1,
                y: (t.offsetHeight > 0 && $t(n.height) / t.offsetHeight) || 1
              }
            : Xt;
      ...
      function qt(e, t, n, r) {
        ...
        let c = Xt;
        t && (r ? Ht(r) && (c = Gt(r)) : (c = Gt(e)));
        const u = Ht(e) ? Lt(e) : window,
          p = !Qt() && n,
          f =
            (l.left +
              (p &&
      ...
      function Jt(e, t) {
        ...
        const r = Kt(e),
          ...
          i = Lt(r);
        return o
          ? t.concat(i, i.visualViewport || [], Yt(r) ? r : [])
          : t.concat(r, Jt(r));
      }
      const en = w.useLayoutEffect;
      var tn = [
          'className',
          'clearValue',
          'cx',
      ...
      function on(e, t) {
        ...
        if (t && e)
          for (var a in t)
            t.hasOwnProperty(a) && t[a] && i.push(''.concat(rn(e, a)));
        return i
          .filter(function (e) {
            return e;
          })
      ...
      function pn(e, t) {
        cn(e) ? window.scrollTo(0, t) : (e.scrollTop = t);
      }
      function fn(e, t) {
        var n =
            arguments.length > 2 && void 0 !== arguments[2]
              ...
              : 200,
          r =
            arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : nn,
          o = un(e),
          i = t - o,
          a = 0;
        !(function t() {
          ...
          pn(e, l), a < n ? window.requestAnimationFrame(t) : r(e);
        })();
      }
      function dn(e, t) {
        ...
        r.bottom + o > n.bottom
          ...
          : r.top - o < n.top && pn(e, Math.max(t.offsetTop - o, 0));
      }
      function mn() {
        try {
      ...
      bn.addEventListener &&
        ...
        (bn.addEventListener('p', nn, yn), bn.removeEventListener('p', nn, !1));
      var vn = hn;
      function gn(e) {
        return null != e;
      }
      ...
      var Cn = ['children', 'innerProps'],
        wn = ['children', 'innerProps'];
      var xn,
        En,
        On,
        Sn = function (e) {
        ...
        Tn = function (e) {
          var t = e.children,
            ...
            s = e.theme,
            l = ((0, w.useContext)(kn) || {}).setPortalPlacement,
            c = (0, w.useRef)(null),
            u = re((0, w.useState)(r), 2),
            p = u[0],
            f = u[1],
            d = re((0, w.useState)(null), 2),
            m = d[0],
            h = d[1],
        ...
        Dn = zn,
        Vn = (function () {
          var e = Bt.apply(void 0, arguments),
            t = 'animation-' + e.name;
          return {
            name: t,
          ...
          xn ||
            ...
            On || (On = En.slice(0)),
            (xn = Object.freeze(
              Object.defineProperties(En, { raw: { value: Object.freeze(On) } })
            )))
        ),
        Hn = function (e) {
          var t = e.delay,
        ...
        Un = ['data'],
        Wn = ['innerRef', 'isDisabled', 'isHidden', 'inputClassName'],
        Yn = {
          gridArea: '1 / 2',
          font: 'inherit',
          minWidth: '2px',
        ...
        Gn = {
          ...
          GroupHeading: function (e) {
            ...
            return _t(
              'div',
              ae({}, ln(e, 'groupHeading', { 'group-heading': !0 }), n)
            );
          },
          IndicatorsContainer: function (e) {
            ...
            return _t(
              'div',
              ae({}, ln(e, 'indicatorsContainer', { indicators: !0 }), n),
              t
            );
          },
          IndicatorSeparator: function (e) {
            ...
            return _t(
              ...
              ae(
                {},
                t,
                ln(e, 'indicatorSeparator', { 'indicator-separator': !0 })
              )
            );
          },
          Input: function (e) {
            ...
            return _t(
              'div',
              ae({}, ln(e, 'input', { 'input-container': !0 }), {
                'data-value': n || ''
              }),
              _t(
                'input',
          ...
          LoadingIndicator: function (e) {
            ...
            return _t(
              ...
              ae(
                {},
                ln(
                  ee(ee({}, i), {}, { innerProps: t, isRtl: n, size: o }),
                  'loadingIndicator',
                  { indicator: !0, 'loading-indicator': !0 }
                ),
                t
              ),
              _t(Hn, { delay: 0, offset: n }),
              _t(Hn, { delay: 160, offset: !0 }),
              _t(Hn, { delay: 320, offset: !n })
            );
          },
          Menu: function (e) {
            var t = e.children,
          ...
          LoadingMessage: function (e) {
            ...
            return _t(
              ...
              ae(
                {},
                ln(
                  ee(ee({}, o), {}, { children: n, innerProps: r }),
                  'loadingMessage',
            ...
            return _t(
              ...
              _t(
                c,
                {
                  ...
                  innerProps: ee(
                    {},
                    ln(e, 'multiValueLabel', { 'multi-value__label': !0 })
                  ),
                  selectProps: s
                },
                t
              ...
              _t(u, {
                ...
                innerProps: ee(
                  ee(
                    {},
                    ln(e, 'multiValueRemove', { 'multi-value__remove': !0 })
                  ),
                  {},
          ...
          Placeholder: function (e) {
            ...
            return _t(
              'div',
              ae({}, ln(e, 'placeholder', { placeholder: !0 }), n),
              t
            );
          },
          SelectContainer: function (e) {
            ...
            return _t(
              ...
              ae(
                {},
                ln(e, 'container', { '--is-disabled': r, '--is-rtl': o }),
                n
              ),
              t
            );
      ...
      function Zn(e, t) {
        ...
        for (var n = 0; n < e.length; n++)
          if (!((r = e[n]) === (o = t[n]) || (qn(r) && qn(o)))) return !1;
        var r, o;
        return !0;
      }
      for (
          ...
          tr = function (e) {
            var t = e.ariaSelection,
              ...
              k = (0, w.useMemo)(
                function () {
                  var e = '';
                  if (y && b.length && !A && E.onFilter) {
                    var t = v({ count: o.length });
                    e = E.onFilter({ inputValue: f, resultsMessage: t });
                  }
                  return e;
                },
                [o, f, y, E, b, v, A]
              ...
              j = (0, w.useMemo)(
                ...
                [C, n, r, d, m, h, y, E, a, g, T]
              ),
              P = _t(
                w.Fragment,
                null,
                _t('span', { id: 'aria-selection' }, O),
                _t('span', { id: 'aria-focused' }, S),
                _t('span', { id: 'aria-results' }, k),
                _t('span', { id: 'aria-guidance' }, j)
              );
            return _t(
              w.Fragment,
              null,
        ...
        for (var ar = nr[ir], sr = 0; sr < ar.letters.length; sr++)
          or[ar.letters[sr]] = ar.base;
      var lr = function (e) {
      ...
      function dr(e) {
        var t = e.innerRef,
          ...
          })(oe(e, fr), 'onExited', 'in', 'enter', 'exit', 'appear');
        return _t(
          'input',
          ae({ ref: t }, n, {
            css: Bt(
              ...
              a = (0, w.useCallback)(
                function (e) {
                  if (Ar) {
                    ...
                    t &&
                      gr() &&
                      (t.addEventListener('touchmove', yr, wr),
                      e &&
                        (e.addEventListener('touchstart', vr, wr),
                        e.addEventListener('touchmove', br, wr))),
                      (Cr += 1);
                  }
                },
                [r]
                ...
                function (e) {
                  if (Ar) {
                    ...
                    (Cr = Math.max(Cr - 1, 0)),
                      ...
                      t &&
                        gr() &&
                        (t.removeEventListener('touchmove', yr, wr),
                        e &&
                          (e.removeEventListener('touchstart', vr, wr),
                          e.removeEventListener('touchmove', br, wr)));
                  }
                },
                [r]
              );
      ...
      var Pr = {
        ...
        Mr = {
          ...
          blurInputOnSelect: mn(),
          captureMenuScroll: !mn(),
          classNames: {},
          closeMenuOnSelect: !0,
          closeMenuOnScroll: !1,
          components: {},
      ...
      function Lr(e, t) {
        var n = e.inputValue,
          ...
          a = t.label,
          s = t.value;
        return (!Wr(e) || !i) && Ur(e, { label: a, value: s, data: o }, r);
      }
      var zr = function (e, t) {
          var n;
          return (
            ...
            if (
              ...
              (t.selectOption = function (e) {
                ...
                if (s) {
                  ...
                  o
                    ? t.setValue([].concat(pe(a), [e]), 'select-option', e)
              ...
              (t.clearValue = function () {
                ...
                t.onChange(An(t.props.isMulti, [], null), {
                  action: 'clear',
                  removedValues: e
                });
              }),
              ...
              (t.getFocusedOptionId = function (e) {
                return zr(t.state.focusableOptionsWithIds, e);
              }),
              (t.getFocusableOptionsWithIds = function () {
                return Nr(
                  _r(t.props, t.state.selectValue),
              ...
              (t.cx = function () {
                for (
                  ...
                  n[r] = arguments[r];
                return on.apply(void 0, [t.props.classNamePrefix].concat(n));
              }),
              ...
              (t.getComponents = function () {
                return (e = t.props), ee(ee({}, Gn), e.components);
                var e;
              }),
              (t.buildCategorizedOptions = function () {
                return _r(t.props, t.state.selectValue);
              }),
              (t.getCategorizedOptions = function () {
                return t.props.menuIsOpen ? t.buildCategorizedOptions() : [];
              }),
              (t.buildFocusableOptions = function () {
                return Br(t.buildCategorizedOptions());
              }),
              (t.getFocusableOptions = function () {
                return t.props.menuIsOpen ? t.buildFocusableOptions() : [];
              }),
              (t.ariaOnChange = function (e, n) {
                t.setState({ ariaSelection: ee({ value: e }, n) });
              }),
              ...
              (t.state.instancePrefix =
                'react-select-' + (t.props.instanceId || ++Yr)),
              (t.state.selectValue = an(e.value)),
              ...
              (t.state.focusableOptionsWithIds = n),
                ...
                (t.state.focusedOptionId = zr(n, r[a]));
            }
            return t;
          }
          return (
            ...
            (n = [
                ...
                value: function () {
                  this.startListeningComposition(),
                    ...
                    this.props.menuIsOpen &&
                      ...
                      dn(this.menuListRef, this.focusedOptionRef);
                }
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return w.createElement(
                    e,
                    ae({}, t, { innerProps: o, isDisabled: n, isFocused: r })
                  );
                }
              },
              {
                ...
                value: function () {
                  ...
                  if (this.hasOptions())
                    ...
                    if (null === R) return null;
                    j = w.createElement(s, u, R);
                  } else {
                    var M = S({ inputValue: m });
                    if (null === M) return null;
                    j = w.createElement(l, u, M);
                  }
                  var I = {
                      minMenuHeight: b,
                      maxMenuHeight: v,
                    ...
                    _ = w.createElement(Tn, ae({}, u, I), function (t) {
                      var n = t.ref,
                        r = t.placerProps,
                        a = r.placement,
                        s = r.maxHeight;
                ...
                value: function () {
                  ...
                  if (i && !r) {
                    if (o) {
                      ...
                      return w.createElement('div', null, c);
                    }
      ...
      Qr.defaultProps = Mr;
      var $r = (0, w.forwardRef)(function (e, t) {
          var n = (function (e) {
            var t = e.defaultInputValue,
              ...
              d = e.value,
              m = oe(e, ie),
              h = re((0, w.useState)(void 0 !== s ? s : n), 2),
              y = h[0],
              b = h[1],
              v = re((0, w.useState)(void 0 !== l ? l : o), 2),
              g = v[0],
              A = v[1],
              C = re((0, w.useState)(void 0 !== d ? d : a), 2),
              x = C[0],
              E = C[1],
              O = (0, w.useCallback)(
                function (e, t) {
          ...
          return w.createElement(Qr, ae({ ref: t }, n));
        }),
        Xr = $r;
      function Gr(e) {
        return (
      ...
      function Zr(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            Kr()
              ? Reflect.construct(t, n || [], Jr(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      no(oo, 'propTypes', { entity: L().object });
      const ao = function () {
      ...
      function co(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            uo()
              ? Reflect.construct(t, n || [], po(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var bo = (function (e) {
        function t(e) {
          ...
          return (
            ...
            ho(fo((n = co(this, t, [e]))), 'onChange', function (e) {
      ...
      function Ao(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            Co()
              ? Reflect.construct(t, n || [], wo(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      ho(bo, 'propTypes', {
        componentname: L().string.isRequired,
        entity: L().object,
        name: L().string.isRequired,
        onChange: L().func,
        value: L().bool
      }),
        ho(bo, 'defaultProps', { value: !1 });
      var ko = (function (e) {
        function t(e) {
          var n;
          !(function (e, t) {
            ...
            Oo(xo((n = Ao(this, t, [e]))), 'onChange', function (e) {
              n.setValue(e.target.value);
            }),
            Oo(xo(n), 'onKeyUp', function (e) {
              e.stopPropagation(), n.setValue(e.target.value);
            }),
            Oo(xo(n), 'onChangeText', function (e) {
      ...
      function jo(e, t) {
        for (var n = 0; n < t.length; n++) {
          ...
          (r.enumerable = r.enumerable || !1),
            (r.configurable = !0),
            'value' in r && (r.writable = !0),
            Object.defineProperty(e, No(r.key), r);
        }
      }
      function Po(e, t, n) {
        return (
          (t = Mo(t)),
          (function (e, t) {
            if (t && ('object' === To(t) || 'function' == typeof t)) return t;
            if (void 0 !== t)
              throw new TypeError(
                'Derived constructors may only return object or undefined'
              );
      ...
      Oo(ko, 'propTypes', {
        ...
        Oo(ko, 'defaultProps', { value: '#ffffff' });
      var Lo = (function (e) {
        function t(e) {
          var n;
          return (
            ...
            Bo(Io((n = Po(this, t, [e]))), 'onChange', function (e) {
      ...
      function Do(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            Vo()
              ? Reflect.construct(t, n || [], Ho(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var $o = (function (e) {
        function t(e) {
          ...
          return (
            ...
            Yo(Uo((n = Do(this, t, [e]))), 'onMouseMove', function (e) {
            ...
            Yo(Uo(n), 'onMouseDown', function (e) {
              e.preventDefault(),
                (n.distance = 0),
            ...
            Yo(Uo(n), 'onBlur', function () {
              n.setValue(parseFloat(n.input.current.value)),
                n.setState({ class: '' });
            }),
            Yo(Uo(n), 'onChange', function (e) {
              n.setState({
                value: e.target.value,
                displayValue: e.target.value
              });
            }),
            Yo(Uo(n), 'onKeyDown', function (e) {
      ...
      function Go(e, t) {
        for (var n = 0; n < t.length; n++) {
          ...
          (r.enumerable = r.enumerable || !1),
            (r.configurable = !0),
            'value' in r && (r.writable = !0),
            Object.defineProperty(e, ni(r.key), r);
        }
      }
      function qo(e, t, n) {
        return (
      ...
      var ri = (function (e) {
        function t(e) {
          ...
          !(function (e, t) {
            ...
            ti(Jo((n = qo(this, t, [e]))), 'onChange', function (e) {
      ...
      function ai(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            si()
              ? Reflect.construct(t, n || [], li(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var di = (function (e) {
        function n(e) {
          ...
          return (
            ...
            pi(ci((r = ai(this, n, [e]))), 'notifyChanged', function (e) {
              r.props.onChange && r.props.onChange(r.props.name, e),
                r.setState({ value: e });
            }),
            pi(ci(r), 'onChange', function (e) {
              var t = e.target.value;
              r.setState({ value: t }), r.notifyChanged(t);
            }),
            pi(ci(r), 'removeMap', function () {
              r.setValue(''), r.notifyChanged('');
            }),
            pi(ci(r), 'openDialog', function () {
      ...
      function vi(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            gi()
              ? Reflect.construct(t, n || [], Ai(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      pi(di, 'propTypes', {
        ...
        name: L().string.isRequired,
        onChange: L().func,
        value: L().oneOfType([L().object, L().string])
      }),
        pi(di, 'defaultProps', { value: '', mapName: 'nomap', dataURL: '' });
      var Oi = (function (e) {
        function t(e) {
          var n;
          return (
            ...
            xi(Ci((n = vi(this, t, [e]))), 'onChange', function (e, t) {
              n.setState(xi({}, e, parseFloat(t.toFixed(5))), function () {
            ...
            },
            {
              ...
              value: function () {
                ...
                return (0, z.jsxs)('div', {
                  className: 'vec4',
                  children: [
                    (0, z.jsx)($o, yi({ name: 'x', value: this.state.x }, e)),
                    (0, z.jsx)($o, yi({ name: 'y', value: this.state.y }, e)),
                    (0, z.jsx)($o, yi({ name: 'z', value: this.state.z }, e)),
                    (0, z.jsx)($o, yi({ name: 'w', value: this.state.w }, e))
                  ]
                });
              }
            }
      ...
      function Pi(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            Ri()
              ? Reflect.construct(t, n || [], Mi(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var Li = (function (e) {
        function t(e) {
          ...
          return (
            ...
            Bi(Ii((n = Pi(this, t, [e]))), 'onChange', function (e, t) {
              n.setState(Bi({}, e, parseFloat(t.toFixed(5))), function () {
                n.props.onChange && n.props.onChange(e, n.state);
              });
            }),
            ...
            },
            {
              ...
              value: function () {
                ...
                return (0, z.jsxs)('div', {
                  className: 'vec3',
                  children: [
                    (0, z.jsx)($o, Ti({ name: 'x', value: this.state.x }, e)),
                    (0, z.jsx)($o, Ti({ name: 'y', value: this.state.y }, e)),
                    (0, z.jsx)($o, Ti({ name: 'z', value: this.state.z }, e))
                  ]
                });
              }
            }
      ...
      function Hi(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            Ui()
              ? Reflect.construct(t, n || [], Wi(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var Gi = (function (e) {
        function t(e) {
          ...
          return (
            ...
            $i(Yi((n = Hi(this, t, [e]))), 'onChange', function (e, t) {
              n.setState($i({}, e, parseFloat(t.toFixed(5))), function () {
                n.props.onChange && n.props.onChange(e, n.state);
              });
            }),
            ...
            },
            {
              ...
              value: function () {
                ...
                return (0, z.jsxs)('div', {
                  className: 'vec2',
                  children: [
                    (0, z.jsx)($o, Di({ name: 'x', value: this.state.x }, e)),
                    (0, z.jsx)($o, Di({ name: 'y', value: this.state.y }, e))
                  ]
                });
              }
            }
      ...
      function ea(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            ta()
              ? Reflect.construct(t, n || [], na(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var aa = (function (e) {
        function t(e) {
          ...
          return (
            ...
            ((n = ea(this, t, [e])).id = e.componentname + ':' + e.name),
            n
          );
        }
        var n, r;
          ...
          (r = [
            {
              ...
              value: function () {
                var e,
                  t = this.props,
                  n =
                    'material' === t.componentname &&
                    ('envMap' === t.name || 'src' === t.name),
                  r = t.schema.type;
                'animation' === t.componentname &&
                  'loop' === t.name &&
                  (r = 'boolean');
                var o =
                    'selector' === t.schema.type
                      ? null ===
                          (e = t.entity.getDOMAttribute(t.componentname)) ||
                        void 0 === e
                        ? void 0
                        : e[t.name]
                      : t.data,
                  i = {
                    ...
                    onChange: function (e, n) {
                      p(t.entity, t.componentname, t.isSingle ? '' : t.name, n);
                    },
                    value: o
                  },
                  a = {
                ...
                if (t.schema.oneOf && t.schema.oneOf.length > 0)
                  return (0, z.jsx)(
                    ri,
                    Ki(Ki({}, i), {}, { options: t.schema.oneOf })
                  );
                if ('map' === r || n) return (0, z.jsx)(di, Ki({}, i));
                switch (r) {
                  case 'number':
                    return (0, z.jsx)($o, Ki(Ki({}, i), a));
                  case 'int':
                    return (0, z.jsx)(
                      $o,
                      Ki(Ki(Ki({}, i), a), {}, { precision: 0 })
                    );
                  case 'vec2':
                    return (0, z.jsx)(Gi, Ki({}, i));
                  case 'vec3':
                    return (0, z.jsx)(Li, Ki({}, i));
                  case 'vec4':
                    return (0, z.jsx)(Oi, Ki({}, i));
                  case 'color':
                    return (0, z.jsx)(ko, Ki({}, i));
                  case 'boolean':
                    return (0, z.jsx)(bo, Ki({}, i));
                  default:
                    return (
                      'string' === t.schema.type &&
                        i.value &&
                        'string' != typeof i.value &&
                        (i.value = t.schema.stringify(i.value)),
                      (0, z.jsx)(Lo, Ki({}, i))
                    );
                }
              }
            },
            {
              ...
              value: function () {
                var e,
                  ...
                  o = ao({
                    propertyRow: !0,
                    propertyRowDefined: t.isSingle
                      ? !!t.entity.getDOMAttribute(t.componentname)
                      : t.name in
                        (t.entity.getDOMAttribute(t.componentname) || {})
                  });
                return (0, z.jsxs)('div', {
      ...
      function ca(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            ua()
              ? Reflect.construct(t, n || [], pa(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      oa(aa, 'propTypes', {
        ...
        entity: L().object.isRequired,
        isSingle: L().bool.isRequired,
        name: L().string.isRequired,
        schema: L().object.isRequired
      });
      var ya = (function (e) {
        function t(e) {
          var n;
          return (
            ...
            ma(fa((n = ca(this, t, [e]))), 'toggleVisibility', function (e) {
              'A' !== e.target.nodeName &&
          ...
          (r = [
            {
              ...
              value: function () {
                ...
                var t = ao(e),
                  n = ao({ content: !0, hide: this.state.collapsed });
                return (0, z.jsxs)('div', {
                  id: this.props.id,
                  className: t,
                  children: [
                    (0, z.jsxs)('div', {
                      ...
                      children: [
                        (0, z.jsx)('div', { className: 'collapse-button' }),
      ...
      function ga(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            Aa()
              ? Reflect.construct(t, n || [], Ca(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      function Oa(e) {
        ...
        return 'symbol' == ba(t) ? t : String(t);
      }
      ma(ya, 'propTypes', {
        className: L().string,
        collapsed: L().bool,
        children: L().oneOfType([L().array, L().element]).isRequired,
        id: L().string
      }),
        ma(ya, 'defaultProps', { collapsed: !1 }),
        o(673);
      var Sa = AFRAME.schema.isSingleProperty,
        ka = (function (e) {
          function n(e) {
            var r;
            return (
              ...
              Ea(wa((r = ga(this, n, [e]))), 'removeComponent', function (e) {
                var n = r.props.name;
                e.stopPropagation(),
                  confirm(
              ...
              Ea(wa(r), 'renderPropertyRows', function () {
                        ...
                        (0, z.jsxs)('div', {
                          ...
                          children: [
                            (0, z.jsx)('span', {
                              ...
                              title: t || e,
                              children: (0, z.jsx)('span', { children: t || e })
                            }),
                            (0, z.jsx)('div', {
      ...
      const Ta = ['visible', 'position', 'scale', 'rotation'];
      function ja(e) {
        return (
          (ja =
            'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
      ...
      function Ra(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            Ma()
              ? Reflect.construct(t, n || [], Ia(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var za = (function (e) {
        function n(e) {
          ...
          return (
            ...
            Na(_a((r = Ra(this, n, [e]))), 'getMixinOptions', function () {
            ...
            Na(_a(r), 'updateMixins', function (e) {
      ...
      function Va(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            Ha()
              ? Reflect.construct(t, n || [], Ua(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      Na(za, 'propTypes', { entity: L().object.isRequired });
      var Qa = {
          camera: (0, z.jsx)('i', {
            title: 'camera',
            children: (0, z.jsx)(G, {
      ...
      function Ga(e, t) {
        for (var n = 0; n < t.length; n++) {
          ...
          (r.enumerable = r.enumerable || !1),
            (r.configurable = !0),
            'value' in r && (r.writable = !0),
            Object.defineProperty(e, es(r.key), r);
        }
      }
      function qa(e, t, n) {
        return (
      ...
      function ts(e, n) {
        var r = AFRAME.INSPECTOR.selectedEntity;
        r.id !== n && ((r.id = n), t.A.emit('entityidchange', r));
      }
      !(function (e, t, n) {
        (t = Ya(t)) in e
          ? Object.defineProperty(e, t, {
          ...
          : (e[t] = n);
      })($a, 'propTypes', { entity: L().object, onDoubleClick: L().func });
      var ns = (function (e) {
        function n() {
          return (
            (function (e, t) {
      ...
      function is(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            as()
              ? Reflect.construct(t, n || [], ss(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var As = (function (e) {
        function n(e) {
          ...
          return (
            ...
            vs(ys((t = ds(this, n, [e]))), 'handleToggle', function () {
      ...
      function xs(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            Es()
              ? Reflect.construct(t, n || [], Os(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      vs(As, 'propTypes', { entity: L().object, visible: L().bool });
      var Ps = (function (e) {
        function t(e) {
          var n;
          return (
            ...
            Ts(Ss((n = xs(this, t, [e]))), 'handleGlobalKeydown', function (e) {
              n.state.isOpen &&
                (27 === e.keyCode ||
            ...
            Ts(Ss(n), 'shouldClickDismiss', function (e) {
              var t = e.target;
              return (
            ...
            Ts(Ss(n), 'handleGlobalMousedown', function (e) {
                    ...
                    children: [
                      (0, z.jsxs)('div', {
                        ...
                        children: [
                          ...
                          (0, z.jsx)('h3', { children: this.props.title })
                        ]
                      }),
                      (0, z.jsx)('div', {
      ...
      function Is(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            _s()
              ? Reflect.construct(t, n || [], Bs(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      Ts(Ps, 'propTypes', {
        ...
        children: L().oneOfType([L().array, L().element]).isRequired,
        isOpen: L().bool,
        extraCloseKeyCode: L().number,
        closeOnClickOutside: L().bool,
        onClose: L().func,
        title: L().string
      }),
        Ts(Ps, 'defaultProps', { closeOnClickOutside: !0 });
      var Hs = (function (e) {
        function n(e) {
          var t;
          return (
            ...
            zs(Ns((t = Is(this, n, [e]))), 'onClose', function (e) {
              t.props.onClose && t.props.onClose();
            }),
            zs(Ns(t), 'selectTexture', function (e) {
              t.props.onClose && t.props.onClose(e);
            }),
            zs(Ns(t), 'generateFromRegistry', function () {
              var e = Ns(t);
            ...
            zs(Ns(t), 'generateFromAssets', function () {
            ...
            zs(Ns(t), 'onChangeFilter', function (e) {
            ...
            (t.imageName = w.createRef()),
            (t.preview = w.createRef()),
            (t.registryGallery = w.createRef()),
            t
          );
        }
        var r, o, i;
        return (
          ...
          (o = [
            ...
            },
            {
              key: 'isValidAsset',
              value: function () {
                var e = Vs(this.state.preview.name);
                        ...
                        children: [
                          ...
                          (0, z.jsxs)('div', {
                            ...
                            children: [
                              ...
                              (0, z.jsx)('span', { children: Ds(e.src) }),
                              (0, z.jsxs)('span', {
      ...
      var Ks = (function (e) {
        function t(e) {
          ...
          return (
            ...
            qs(Xs((n = Ys(this, t, [e]))), 'onClose', function () {
      ...
      qs(Ks, 'propTypes', { isOpen: L().bool, onClose: L().func });
      var Js = o(181),
        el = o.n(Js);
      function tl(e) {
        return (
      ...
      function rl(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            ol()
              ? Reflect.construct(t, n || [], il(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var ul = (function (e) {
        function n(e) {
          ...
          return (
            ...
            ll(al((r = rl(this, n, [e]))), 'onClick', function () {
              return r.props.selectEntity(r.props.entity);
            }),
            ll(al(r), 'onDoubleClick', function () {
              return t.A.emit('objectfocus', r.props.entity.object3D);
            }),
            ll(al(r), 'toggleVisibility', function () {
              ...
              value: function () {
                ...
                e =
                  o.children.length > 0 && !n
                    ...
                    : (0, z.jsx)('span', { className: 'collapsespace' });
                var c =
                    'a-scene' === i
                      ? o.object3D.visible
      ...
      function dl(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            ml()
              ? Reflect.construct(t, n || [], hl(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      ll(ul, 'propTypes', {
        ...
        isSelected: L().bool,
        selectEntity: L().func,
        toggleExpandedCollapsed: L().func
      });
      var Cl = (function (e) {
        function n(e) {
          var t;
          return (
            ...
            vl(yl((t = dl(this, n, [e]))), 'writeChanges', function () {
            ...
            vl(yl(t), 'toggleScenePlaying', function () {
                  ...
                  children: (0, z.jsxs)('div', {
                    ...
                    children: [
                      (0, z.jsxs)('a', {
                        ...
                        children: [
                          (0, z.jsx)(G, { icon: I }),
                          (0, z.jsx)('span', { children: 'Add Entity' })
                        ]
                      }),
                      (0, z.jsx)('a', {
                        id: 'playPauseScene',
                        ...
                        children: this.state.isPlaying
                          ? (0, z.jsxs)(z.Fragment, {
                              children: [
                                (0, z.jsx)(G, { icon: k }),
                                (0, z.jsx)('span', { children: 'Pause Scene' })
                              ]
                            })
                          : (0, z.jsxs)(z.Fragment, {
                              children: [
                                (0, z.jsx)(G, { icon: R }),
                                (0, z.jsx)('span', { children: 'Play Scene' })
                              ]
                            })
                      })
                    ]
      ...
      var Rl = (function (e) {
        function n(e) {
          ...
          return (
            ...
            ((t = Ol(this, n, [e])).state = { selectedCamera: 'perspective' }),
              ...
              value: function () {
                return (0, z.jsx)('div', {
                  ...
                  children: (0, z.jsx)(Xr, {
                    ...
                    options: jl,
                    simpleValue: !0,
                    value: Pl(this.state.selectedCamera),
                    isSearchable: !1,
      ...
      function Nl(e, t, n) {
        return (
          (t = zl(t)),
          (function (e, t) {
            if (t && ('object' === Ml(t) || 'function' == typeof t)) return t;
            if (void 0 !== t)
              throw new TypeError(
                'Derived constructors may only return object or undefined'
              );
            ...
            e,
            Ll()
              ? Reflect.construct(t, n || [], zl(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var Ul = (function (e) {
        function n(e) {
          ...
          return (
            ...
            Vl(Fl((r = Nl(this, n, [e]))), 'selectEntity', function (e) {
              for (var n = !1, o = 0; o < r.state.filteredEntities.length; o++)
                r.state.filteredEntities[o].entity === e &&
                  (r.setState({ selectedEntity: e, selectedIndex: o }),
                  r.expandToRoot(e),
                  r.props.onChange && r.props.onChange(e),
                  t.A.emit('entityselect', e, !0),
                  (n = !0));
              n || r.setState({ selectedEntity: null, selectedIndex: -1 });
            }),
            Vl(Fl(r), 'rebuildEntityOptions', function () {
              var e = [{ depth: 0, entity: r.props.scene }];
              !(function t(n, r) {
                if (n) {
                  r += 1;
                ...
                r.setState({
                  entities: e,
                  filteredEntities: r.getFilteredEntities(r.state.filter, e)
                });
            }),
            Vl(Fl(r), 'selectIndex', function (e) {
              e >= 0 &&
                e < r.state.entities.length &&
                r.selectEntity(r.state.entities[e].entity);
            }),
            Vl(Fl(r), 'onFilterKeyUp', function (e) {
              27 === e.keyCode && r.clearFilter();
            }),
            Vl(Fl(r), 'onKeyDown', function (e) {
              switch (e.keyCode) {
                case 37:
                case 38:
                case 39:
            ...
            Vl(Fl(r), 'onKeyUp', function (e) {
              if (null !== r.props.selectedEntity)
                switch (e.keyCode) {
                  case 37:
                    r.isExpanded(r.props.selectedEntity) &&
                      r.toggleExpandedCollapsed(r.props.selectedEntity);
                    break;
                  case 38:
                    r.selectIndex(
                      r.previousExpandedIndexTo(r.state.selectedIndex)
                    );
                    break;
                  case 39:
                    r.isExpanded(r.props.selectedEntity) ||
                    ...
                    break;
                  case 40:
                    r.selectIndex(r.nextExpandedIndexTo(r.state.selectedIndex));
                }
            }),
            Vl(Fl(r), 'isVisibleInSceneGraph', function (e) {
              var t = e.parentNode;
              if (!t) return !1;
              for (; void 0 !== t && t.isEntity; ) {
                if (!r.isExpanded(t)) return !1;
                t = t.parentNode;
              }
              return !0;
            }),
            Vl(Fl(r), 'isExpanded', function (e) {
              return !0 === r.state.expandedElements.get(e);
            }),
            Vl(Fl(r), 'toggleExpandedCollapsed', function (e) {
              r.setState({
                expandedElements: r.state.expandedElements.set(
                  e,
                  !r.isExpanded(e)
                )
              });
            }),
            Vl(Fl(r), 'expandToRoot', function (e) {
              for (var t = e.parentNode; void 0 !== t && t.isEntity; )
                r.state.expandedElements.set(t, !0), (t = t.parentNode);
              r.setState({ expandedElements: r.state.expandedElements });
            }),
            Vl(Fl(r), 'previousExpandedIndexTo', function (e) {
              for (var t = e - 1; t >= 0; t--) {
                var n = r.state.entities[t].entity;
                if (r.isVisibleInSceneGraph(n)) return t;
              }
              return -1;
            }),
            Vl(Fl(r), 'nextExpandedIndexTo', function (e) {
              for (var t = e + 1; t < r.state.entities.length; t++) {
                var n = r.state.entities[t].entity;
                if (r.isVisibleInSceneGraph(n)) return t;
              }
              return -1;
            }),
            Vl(Fl(r), 'onChangeFilter', function (e) {
              var t = e.target.value;
              r.setState({ filter: t }), r.updateFilteredEntities(t);
            }),
            Vl(Fl(r), 'clearFilter', function () {
              r.setState({ filter: '' }), r.updateFilteredEntities('');
            }),
            Vl(Fl(r), 'renderEntities', function () {
              return r.state.filteredEntities.map(function (e, t) {
                return r.isVisibleInSceneGraph(e.entity) || r.state.filter
                  ? (0, w.createElement)(
                      ul,
                      _l(
                        _l({}, e),
                        ...
                        {
                          key: t,
                          isFiltering: !!r.state.filter,
                          isExpanded: r.isExpanded(e.entity),
                          isSelected: r.props.selectedEntity === e.entity,
                          selectEntity: r.selectEntity,
                          toggleExpandedCollapsed: r.toggleExpandedCollapsed
                        }
                      )
                    )
                  : null;
            ...
            (r.rebuildEntityOptions = el()(
              r.rebuildEntityOptions.bind(Fl(r)),
              1e3
            )),
            (r.updateFilteredEntities = el()(
              r.updateFilteredEntities.bind(Fl(r)),
              500
            )),
            r
          );
                      ...
                      children: [
                        ...
                        (0, z.jsxs)('div', {
                          ...
                          children: [
                            ...
                            e,
                            !this.state.filter && (0, z.jsx)(G, { icon: M })
                          ]
                        })
                      ]
                    }),
      ...
      function Yl(e, t) {
        for (var n = 0; n < t.length; n++) {
          ...
          (r.enumerable = r.enumerable || !1),
            (r.configurable = !0),
            'value' in r && (r.writable = !0),
            Object.defineProperty(e, Kl(r.key), r);
        }
      }
      function Ql(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            $l()
              ? Reflect.construct(t, n || [], Xl(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var Jl = [
          { value: 'translate', icon: (0, z.jsx)(G, { icon: T }) },
          {
            value: 'rotate',
            icon: (0, z.jsx)(G, {
              icon: {
              ...
              },
              {
                ...
                value: function () {
                  return (0, z.jsx)('div', {
                    ...
                    children: this.renderTransformButtons()
                  });
                }
              }
            ]) && Yl(r.prototype, o),
      ...
      function nc(e, t) {
        for (var n = 0; n < t.length; n++) {
          ...
          (r.enumerable = r.enumerable || !1),
            (r.configurable = !0),
            'value' in r && (r.writable = !0),
            Object.defineProperty(e, rc(r.key), r);
        }
      }
      function rc(e) {
        var t = (function (e, t) {
      ...
      function oc(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            ic()
              ? Reflect.construct(t, n || [], ac(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var Ac = (function (e) {
          function n(e) {
            ...
            return (
              ...
              vc(yc((r = dc(this, n, [e]))), 'onCloseHelpModal', function (e) {
                r.setState({ isHelpOpen: !1 });
              }),
              vc(yc(r), 'onModalTextureOnClose', function (e) {
                r.setState({ isModalTexturesOpen: !1 }),
                  r.state.textureOnClose && r.state.textureOnClose(e);
              }),
              vc(yc(r), 'toggleEdit', function () {
                ...
                value: function () {
                  var e = this.state.sceneEl,
                    t = this.state.inspectorEnabled
                      ? (0, z.jsx)(z.Fragment, {
                          children: (0, z.jsx)('p', { children: 'Show' })
                        })
                      : (0, z.jsx)(z.Fragment, {
                          children: (0, z.jsx)('p', { children: 'Edit' })
                        });
                  return (0, z.jsxs)('div', {
                    children: [
                      (0, z.jsx)('a', {
                      ...
                      (0, z.jsxs)('div', {
                        ...
                        children: [
                          ...
                          (0, z.jsxs)('div', {
                            ...
                            children: [
                              (0, z.jsxs)('div', {
                                className: 'scenegraph-menubar',
                                children: [
                                  (0, z.jsx)('div', {
                                    id: 'scenegraph-menu-back'
                                  }),
                                  (0, z.jsx)(ec, {})
                                ]
                              }),
      ...
      const Ec = THREE;
      let Oc, Sc, kc, Tc;
      function jc(e, t = 1 / 0, n = null) {
        Sc || (Sc = new Ec.PlaneGeometry(2, 2, 1, 1)),
          kc ||
            (kc = new Ec.ShaderMaterial({
              uniforms: { blitTexture: new Ec.Uniform(e) },
              vertexShader:
                '\n\t\t\tvarying vec2 vUv;\n\t\t\tvoid main(){\n\t\t\t\tvUv = uv;\n\t\t\t\tgl_Position = vec4(position.xy * 1.0,0.,.999999);\n\t\t\t}',
              fragmentShader:
                '\n\t\t\tuniform sampler2D blitTexture; \n\t\t\tvarying vec2 vUv;\n\n\t\t\tvoid main(){ \n\t\t\t\tgl_FragColor = vec4(vUv.xy, 0, 1);\n\t\t\t\t\n\t\t\t\t#ifdef IS_SRGB\n\t\t\t\tgl_FragColor = sRGBTransferOETF( texture2D( blitTexture, vUv) );\n\t\t\t\t#else\n\t\t\t\tgl_FragColor = texture2D( blitTexture, vUv);\n\t\t\t\t#endif\n\t\t\t}'
            })),
          (kc.uniforms.blitTexture.value = e),
          (kc.defines.IS_SRGB = e.colorSpace == Ec.SRGBColorSpace),
          (kc.needsUpdate = !0),
          Tc || ((Tc = new Ec.Mesh(Sc, kc)), (Tc.frustumCulled = !1));
        const r = new Ec.PerspectiveCamera(),
          o = new Ec.Scene();
        o.add(Tc),
          null === n && (n = Oc = new Ec.WebGLRenderer({ antialias: !1 }));
        ...
        const c = new Ec.CanvasTexture(s);
        return (
          ...
          (c.wrapT = e.wrapT),
          (c.name = e.name),
          Oc && (Oc.forceContextLoss(), Oc.dispose(), (Oc = null)),
          c
        );
      }
      const Pc = {
      ...
      const Mc = 5120,
        ...
        Bc = 5123,
        Nc = 34962,
        Lc = 'KHR_mesh_quantization',
        zc = {};
      (zc[Ec.NearestFilter] = 9728),
        (zc[Ec.NearestMipmapNearestFilter] = 9984),
        (zc[Ec.NearestMipmapLinearFilter] = 9986),
        (zc[Ec.LinearFilter] = 9729),
        (zc[Ec.LinearMipmapNearestFilter] = 9985),
        (zc[Ec.LinearMipmapLinearFilter] = 9987),
        (zc[Ec.ClampToEdgeWrapping] = 33071),
        (zc[Ec.RepeatWrapping] = 10497),
        (zc[Ec.MirroredRepeatWrapping] = 33648);
      const Fc = {
          scale: 'scale',
      ...
      class Qc {
        constructor() {
          (this.plugins = []),
            ...
            (this.json = {
              asset: {
                version: '2.0',
                generator: 'THREE.GLTFExporter r' + Ec.REVISION
              }
            }),
            (this.cache = {
              meshes: new Map(),
        ...
        buildMetalRoughTexture(e, t) {
          if (e === t) return e;
          function n(e) {
            return e.colorSpace === Ec.SRGBColorSpace
              ? function (e) {
                  return e < 0.04045
                    ? 0.0773993808 * e
          ...
          console.warn(
            ...
            e instanceof Ec.CompressedTexture && (e = jc(e)),
            t instanceof Ec.CompressedTexture && (t = jc(t));
          ...
          const u = (e || t).clone();
          return (
            (u.source = new Ec.Source(s)),
            (u.colorSpace = Ec.NoColorSpace),
                ...
                : (0 === n
                    ...
                    : 1 === n
                      ...
                      : 2 === n
                        ...
                        : 3 === n && (r = e.getW(o)),
                  !0 === e.normalized &&
                    (r = Ec.MathUtils.normalize(r, e.array))),
                5126 === t
                  ? c.setFloat32(u, r, !0)
                  : 5124 === t
                    ? c.setInt32(u, r, !0)
        ...
        processAccessor(e, t, n, r) {
          ...
          else if (e.array.constructor === Int16Array) i = _c;
          else if (e.array.constructor === Uint16Array) i = Bc;
          else if (e.array.constructor === Int8Array) i = Mc;
          else {
                  ...
                  : (0 === t
                      ...
                      : 1 === t
                        ...
                        : 2 === t
                          ...
                          : 3 === t && (n = e.getW(o)),
                    !0 === e.normalized &&
                      (n = Ec.MathUtils.normalize(n, e.array))),
        ...
        processImage(e, t, n, r = 'image/png') {
          if (null !== e) {
            ...
            const d = f.getContext('2d', { willReadFrequently: !0 });
            if (
        ...
        processSampler(e) {
          ...
          const n = {
            magFilter: zc[e.magFilter],
            minFilter: zc[e.minFilter],
            wrapS: zc[e.wrapS],
            wrapT: zc[e.wrapT]
          };
        ...
        processTexture(e) {
          ...
          r.textures || (r.textures = []),
            e instanceof Ec.CompressedTexture && (e = jc(e, t.maxTextureSize));
        ...
        processMaterial(e) {
          ...
          e.transparent
            ...
            e.side === Ec.DoubleSide && (r.doubleSided = !0),
        ...
        processMesh(e) {
          ...
          for (let e = 0, n = b.length; e < n; e++) {
            ...
            if (
              ...
              (void 0 === b[e].start && void 0 === b[e].count) ||
                (r += ':' + b[e].start + ':' + b[e].count),
                t.attributes.has(r)
            ...
            const r = this.processMaterial(y[b[e].materialIndex]);
          ...
          const v = n.meshes.push(s) - 1;
          return t.meshes.set(o, v), v;
        }
        detectMeshQuantization(e, t) {
          if (this.extensionsUsed[Lc]) return;
          let n;
          ...
          Pc[r] &&
            Pc[r].includes(n) &&
            ((this.extensionsUsed[Lc] = !0),
            (this.extensionsRequired[Lc] = !0));
        }
        processCamera(e) {
          const t = this.json;
          t.cameras || (t.cameras = []);
          ...
          return (
            n
              ...
              : (r.perspective = {
                  ...
                  yfov: Ec.MathUtils.degToRad(e.fov),
                  zfar: e.far <= 0 ? 0.001 : e.far,
                  znear: e.near < 0 ? 0 : e.near
                }),
        ...
        processAnimation(e, t) {
          ...
          const o = (e = Rc.Utils.mergeMorphTargetTracks(e.clone(), t)).tracks,
            i = [],
            a = [];
          for (let e = 0; e < o.length; ++e) {
            const n = o[e],
              s = Ec.PropertyBinding.parseTrackName(n.name);
            let l = Ec.PropertyBinding.findNode(t, s.nodeName);
            const c = Fc[s.propertyName];
            if (
              ('bones' === s.objectName &&
                (l =
                  !0 === l.isSkinnedMesh
            ...
            c === Fc.morphTargetInfluences &&
              (f /= l.morphTargetInfluences.length),
              !0 ===
              n.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline
                ? ((p = 'CUBICSPLINE'), (f /= 3))
                : (p =
                    n.getInterpolation() === Ec.InterpolateDiscrete
                      ? 'STEP'
                      : 'LINEAR'),
              a.push({
                input: this.processAccessor(new Ec.BufferAttribute(n.times, u)),
                output: this.processAccessor(
                  new Ec.BufferAttribute(n.values, f)
                ),
                interpolation: p
              }),
              i.push({
        ...
        processNode(e) {
          ...
          if (n.trs) {
            const t = e.quaternion.toArray(),
              ...
              r = e.scale.toArray();
            Vc(t, [0, 0, 0, 1]) || (o.rotation = t),
              Vc(n, [0, 0, 0]) || (o.translation = n),
              Vc(r, [1, 1, 1]) || (o.scale = r);
          } else
        ...
        processInput(e) {
          ...
          for (let t = 0; t < e.length; t++)
            e[t] instanceof Ec.Scene ? this.processScene(e[t]) : n.push(e[t]);
        ...
        writeNode(e, t) {
          ...
          for (let e = 0; e < r.count; e++)
            r.getMatrixAt(e, s),
              ...
              u.toArray(a, 3 * e);
          const p = {
            TRANSLATION: n.processAccessor(new Ec.BufferAttribute(o, 3)),
            ROTATION: n.processAccessor(new Ec.BufferAttribute(i, 4)),
            SCALE: n.processAccessor(new Ec.BufferAttribute(a, 3))
          };
      ...
      Rc.Utils = {
        ...
        mergeMorphTargetTracks: function (e, t) {
          ...
          for (let e = 0; e < o.length; ++e) {
            let i = o[e];
            const a = Ec.PropertyBinding.parseTrackName(i.name),
              s = Ec.PropertyBinding.findNode(t, a.nodeName);
            if (
            ...
            if (
              ...
              console.warn(
                ...
                (i = i.clone()),
                i.setInterpolation(Ec.InterpolateLinear);
            }
      ...
      function Cu() {
        var e = this;
        (this.assetsLoader = new a()),
          (this.exporters = { gltf: new Rc() }),
          (this.history = o(253)),
          (this.isFirstOpen = !0),
          (this.modules = {}),
          (this.opened = !1),
      ...
      (Au.styleTagTransform = vu()),
        (Au.setAttributes = mu()),
        (Au.insert = fu().bind(null, 'head')),
        (Au.domAPI = uu()),
        (Au.insertStyleElement = yu()),
        lu()(gu.A, Au),
        gu.A && gu.A.locals && gu.A.locals,
        (Cu.prototype = {
          init: function () {
            var e = this;
            this.sceneEl.camera
          ...
          initUI: function () {
            var t = this;
            C.init(this), this.initEvents(), (this.selected = null);
            var n = document.createElement('div');
            (n.id = 'aframeInspector'),
              n.setAttribute('data-aframe-inspector', 'app'),
              document.body.appendChild(n),
              (0, e.H)(n).render((0, z.jsx)(Ac, {})),
          ...
          addHelper: function (e) {
            ...
            if (e instanceof THREE.Camera)
              this.cameraHelper = t = new THREE.CameraHelper(e);
